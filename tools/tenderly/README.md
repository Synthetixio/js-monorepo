...
# Synthetix RewardsDistribution contract owner address (used in `tenderly-getsnx`)
export TENDERLY_SNX_OWNER_ADDRESS="0xeb3107117fead7de89cd14d463d340a2e6917769"
...
# Add 100 SNX to the waller (when TENDERLY_WALLET_ADDRESS  and TENDERLY_SNX_OWNER_ADDRESS are set)
➜ tenderly-getsnx
0xTXN_ID
# Alternatively:
