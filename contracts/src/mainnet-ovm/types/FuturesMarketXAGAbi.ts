...
export interface FuturesMarketXAGAbiInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketXAGAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketXAGAbiInterface;
