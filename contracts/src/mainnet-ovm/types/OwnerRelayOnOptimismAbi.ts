...
export interface OwnerRelayOnOptimismAbiInterface extends utils.Interface {
  functions: {
...
export interface OwnerRelayOnOptimismAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OwnerRelayOnOptimismAbiInterface;
