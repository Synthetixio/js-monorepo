...
export interface FuturesMarketAVAXAbiInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketAVAXAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketAVAXAbiInterface;
