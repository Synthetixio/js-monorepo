...
export interface TokenStatesAVAXAbiInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesAVAXAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesAVAXAbiInterface;
