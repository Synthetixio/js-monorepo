...
export interface TokenStatesMATICAbiInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesMATICAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesMATICAbiInterface;
