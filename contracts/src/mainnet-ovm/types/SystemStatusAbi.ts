...
export interface SystemStatusAbiInterface extends utils.Interface {
  functions: {
...
export interface SystemStatusAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SystemStatusAbiInterface;
  ...
  functions: {
    ...
    getSynthExchangeSuspensions(
      ...
      overrides?: CallOverrides
    ): Promise<[boolean[], BigNumber[]] & { exchangeSuspensions: boolean[]; reasons: BigNumber[] }>;
