...
export interface TokenStatesEURAbiInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesEURAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesEURAbiInterface;
