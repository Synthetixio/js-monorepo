...
export interface FuturesMarketXAUAbiInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketXAUAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketXAUAbiInterface;
