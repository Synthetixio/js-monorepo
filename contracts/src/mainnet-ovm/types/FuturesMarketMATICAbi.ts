...
export interface FuturesMarketMATICAbiInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketMATICAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketMATICAbiInterface;
