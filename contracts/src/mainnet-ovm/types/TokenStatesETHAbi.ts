...
export interface TokenStatesETHAbiInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesETHAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesETHAbiInterface;
