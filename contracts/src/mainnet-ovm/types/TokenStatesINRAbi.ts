...
export interface TokenStatesINRAbiInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesINRAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesINRAbiInterface;
