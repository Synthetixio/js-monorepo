...
export interface FuturesMarketEURAbiInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketEURAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketEURAbiInterface;
