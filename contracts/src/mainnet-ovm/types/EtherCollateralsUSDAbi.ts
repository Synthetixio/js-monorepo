...
export interface EtherCollateralsUSDAbiInterface extends utils.Interface {
  functions: {
...
export interface EtherCollateralsUSDAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EtherCollateralsUSDAbiInterface;
