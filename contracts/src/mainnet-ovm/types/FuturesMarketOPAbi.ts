...
export interface FuturesMarketOPAbiInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketOPAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketOPAbiInterface;
