...
export interface FuturesMarketDebtRatioAbiInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketDebtRatioAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketDebtRatioAbiInterface;
