...
export interface FuturesMarketBNBAbiInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketBNBAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketBNBAbiInterface;
