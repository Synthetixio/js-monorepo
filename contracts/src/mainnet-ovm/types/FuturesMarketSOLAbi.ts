...
export interface FuturesMarketSOLAbiInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketSOLAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketSOLAbiInterface;
