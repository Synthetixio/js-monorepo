...
export interface AddressResolverAbiInterface extends utils.Interface {
  functions: {
...
export interface AddressResolverAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AddressResolverAbiInterface;
