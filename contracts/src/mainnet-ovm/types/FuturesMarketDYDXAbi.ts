...
export interface FuturesMarketDYDXAbiInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketDYDXAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketDYDXAbiInterface;
