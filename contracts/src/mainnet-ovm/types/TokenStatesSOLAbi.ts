...
export interface TokenStatesSOLAbiInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesSOLAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesSOLAbiInterface;
