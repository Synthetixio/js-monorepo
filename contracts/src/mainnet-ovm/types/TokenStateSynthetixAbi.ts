...
export interface TokenStateSynthetixAbiInterface extends utils.Interface {
  functions: {
...
export interface TokenStateSynthetixAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStateSynthetixAbiInterface;
