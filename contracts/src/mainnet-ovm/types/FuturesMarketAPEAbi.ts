...
export interface FuturesMarketAPEAbiInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketAPEAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketAPEAbiInterface;
