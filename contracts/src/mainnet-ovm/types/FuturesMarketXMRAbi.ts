...
export interface FuturesMarketXMRAbiInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketXMRAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketXMRAbiInterface;
