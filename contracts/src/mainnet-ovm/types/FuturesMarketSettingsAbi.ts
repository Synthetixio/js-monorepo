...
export interface FuturesMarketSettingsAbiInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketSettingsAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketSettingsAbiInterface;
