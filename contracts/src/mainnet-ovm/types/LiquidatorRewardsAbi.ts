...
export interface LiquidatorRewardsAbiInterface extends utils.Interface {
  functions: {
...
export interface LiquidatorRewardsAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LiquidatorRewardsAbiInterface;
