...
export interface FuturesMarketAAVEAbiInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketAAVEAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketAAVEAbiInterface;
