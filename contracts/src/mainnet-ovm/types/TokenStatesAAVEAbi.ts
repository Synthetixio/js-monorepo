...
export interface TokenStatesAAVEAbiInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesAAVEAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesAAVEAbiInterface;
