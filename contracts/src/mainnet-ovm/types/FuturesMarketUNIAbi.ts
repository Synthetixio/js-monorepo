...
export interface FuturesMarketUNIAbiInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketUNIAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketUNIAbiInterface;
