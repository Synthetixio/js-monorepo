...
export const name = 'FuturesMarketOP';
...
export interface FuturesMarketOPInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketOP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketOPInterface;
