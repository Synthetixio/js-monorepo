...
export const name = 'FuturesMarketAAVE';
export const address = '0x001b7876F567f0b3A639332Ed1e363839c6d85e2';
...
export interface FuturesMarketAAVEInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketAAVE extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketAAVEInterface;
