...
export const name = 'FuturesMarketXAU';
export const address = '0x4434f56ddBdE28fab08C4AE71970a06B300F8881';
...
export interface FuturesMarketXAUInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketXAU extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketXAUInterface;
