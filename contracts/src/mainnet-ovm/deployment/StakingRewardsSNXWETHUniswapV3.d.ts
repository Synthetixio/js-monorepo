...
export interface StakingRewardsSNXWETHUniswapV3Interface extends utils.Interface {
  functions: {
...
export interface StakingRewardsSNXWETHUniswapV3 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardsSNXWETHUniswapV3Interface;
