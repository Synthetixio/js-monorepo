...
export interface ProxysBTCAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface ProxysBTCAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxysBTCAbiTypesInterface;
