...
export interface ProxysUNIAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface ProxysUNIAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxysUNIAbiTypesInterface;
