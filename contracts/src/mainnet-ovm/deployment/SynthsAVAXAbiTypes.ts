...
export interface SynthsAVAXAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface SynthsAVAXAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsAVAXAbiTypesInterface;
