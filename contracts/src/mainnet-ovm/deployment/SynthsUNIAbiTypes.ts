...
export interface SynthsUNIAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface SynthsUNIAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsUNIAbiTypesInterface;
