...
export interface TokenStatesSOLAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesSOLAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesSOLAbiTypesInterface;
