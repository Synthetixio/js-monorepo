...
export interface TokenStatesUNIAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesUNIAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesUNIAbiTypesInterface;
