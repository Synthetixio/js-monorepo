...
export interface SynthsINRAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface SynthsINRAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsINRAbiTypesInterface;
