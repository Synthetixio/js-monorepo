...
export interface ProxysINRAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface ProxysINRAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxysINRAbiTypesInterface;
