...
export interface TokenStatesMATICInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesMATIC extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesMATICInterface;
