...
export interface SynthsAAVEAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface SynthsAAVEAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsAAVEAbiTypesInterface;
