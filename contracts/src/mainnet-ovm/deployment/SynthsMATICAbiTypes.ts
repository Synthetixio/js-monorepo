...
export interface SynthsMATICAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface SynthsMATICAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsMATICAbiTypesInterface;
