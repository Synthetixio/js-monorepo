...
export interface TokenStatesBTCAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesBTCAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesBTCAbiTypesInterface;
