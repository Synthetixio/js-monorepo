...
export interface ProxysMATICAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface ProxysMATICAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxysMATICAbiTypesInterface;
