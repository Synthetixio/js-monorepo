...
export interface TokenStatesEURAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesEURAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesEURAbiTypesInterface;
