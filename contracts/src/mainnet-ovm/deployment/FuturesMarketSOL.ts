...
export const name = 'FuturesMarketSOL';
export const address = '0xcF853f7f8F78B2B801095b66F8ba9c5f04dB1640';
...
export interface FuturesMarketSOLInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketSOL extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketSOLInterface;
