...
export interface FuturesMarketXAGAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketXAGAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketXAGAbiTypesInterface;
