...
export interface FuturesMarketMATICAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketMATICAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketMATICAbiTypesInterface;
