...
export interface FuturesMarketDebtRatioInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketDebtRatio extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketDebtRatioInterface;
