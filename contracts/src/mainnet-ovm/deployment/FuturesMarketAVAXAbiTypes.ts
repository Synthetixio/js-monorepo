...
export interface FuturesMarketAVAXAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketAVAXAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketAVAXAbiTypesInterface;
