...
export interface SystemSettingsLibAbiTypesInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "MAX_ATOMIC_TWAP_WINDOW",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "MAX_ATOMIC_VOLUME_PER_BLOCK",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MAX_CROSS_DOMAIN_GAS_LIMIT",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MAX_EXCHANGE_FEE_RATE",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MAX_FEE_PERIOD_DURATION",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MAX_ISSUANCE_RATIO",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MAX_LIQUIDATION_DELAY",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MAX_LIQUIDATION_PENALTY",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MAX_LIQUIDATION_RATIO",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MAX_MINIMUM_STAKE_TIME",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MAX_TARGET_THRESHOLD",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MAX_WRAPPER_BURN_FEE_RATE",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MAX_WRAPPER_MINT_FEE_RATE",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MIN_ATOMIC_TWAP_WINDOW",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "MIN_CROSS_DOMAIN_GAS_LIMIT",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MIN_FEE_PERIOD_DURATION",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MIN_LIQUIDATION_DELAY",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "RATIO_FROM_TARGET_BUFFER",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "SETTINGS_CONTRACT_NAME",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface SystemSettingsLibAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SystemSettingsLibAbiTypesInterface;
