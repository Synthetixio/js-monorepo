...
export interface SynthsUSDAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface SynthsUSDAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsUSDAbiTypesInterface;
