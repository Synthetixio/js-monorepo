...
export interface SynthsSOLAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface SynthsSOLAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsSOLAbiTypesInterface;
