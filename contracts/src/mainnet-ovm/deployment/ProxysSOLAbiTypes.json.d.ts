...
export interface ProxysSOLAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface ProxysSOLAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxysSOLAbiTypesInterface;
