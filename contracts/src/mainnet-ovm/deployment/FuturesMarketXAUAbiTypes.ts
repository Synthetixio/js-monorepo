...
export interface FuturesMarketXAUAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketXAUAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketXAUAbiTypesInterface;
