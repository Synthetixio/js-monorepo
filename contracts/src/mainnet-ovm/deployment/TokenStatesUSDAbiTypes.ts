...
export interface TokenStatesUSDAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesUSDAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesUSDAbiTypesInterface;
