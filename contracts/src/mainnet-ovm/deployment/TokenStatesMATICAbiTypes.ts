...
export interface TokenStatesMATICAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesMATICAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesMATICAbiTypesInterface;
