...
export interface StakingRewardssBTCCurveAbiInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardssBTCCurveAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardssBTCCurveAbiInterface;
