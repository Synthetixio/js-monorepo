...
export interface TokenStatesAUDAbiInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesAUDAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesAUDAbiInterface;
