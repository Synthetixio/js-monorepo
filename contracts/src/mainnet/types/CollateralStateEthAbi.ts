...
export interface CollateralStateEthAbiInterface extends utils.Interface {
  functions: {
...
export interface CollateralStateEthAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CollateralStateEthAbiInterface;
