...
export interface SystemSettingsLibAbiInterface extends utils.Interface {
  functions: {
...
export interface SystemSettingsLibAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SystemSettingsLibAbiInterface;
