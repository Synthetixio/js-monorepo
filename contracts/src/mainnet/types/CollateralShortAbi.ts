...
export interface CollateralShortAbiInterface extends utils.Interface {
  functions: {
...
export interface CollateralShortAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CollateralShortAbiInterface;
