...
export interface StakingRewardssTSLABalancerAbiInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardssTSLABalancerAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardssTSLABalancerAbiInterface;
