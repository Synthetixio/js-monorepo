...
export interface StakingRewardssXAUUniswapV2AbiInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardssXAUUniswapV2Abi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardssXAUUniswapV2AbiInterface;
