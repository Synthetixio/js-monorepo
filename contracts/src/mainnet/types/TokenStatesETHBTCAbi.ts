...
export interface TokenStatesETHBTCAbiInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesETHBTCAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesETHBTCAbiInterface;
