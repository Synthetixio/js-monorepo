...
export interface TokenStatesDOTAbiInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesDOTAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesDOTAbiInterface;
