...
export interface IssuanceEternalStorageAbiInterface extends utils.Interface {
  functions: {
...
export interface IssuanceEternalStorageAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IssuanceEternalStorageAbiInterface;
