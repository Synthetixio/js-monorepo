...
export interface ShortingRewardssETHAbiInterface extends utils.Interface {
  functions: {
...
export interface ShortingRewardssETHAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ShortingRewardssETHAbiInterface;
