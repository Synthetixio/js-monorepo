...
export interface TokenStatesADAAbiInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesADAAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesADAAbiInterface;
