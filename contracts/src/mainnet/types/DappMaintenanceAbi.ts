...
export interface DappMaintenanceAbiInterface extends utils.Interface {
  functions: {
...
export interface DappMaintenanceAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DappMaintenanceAbiInterface;
