...
export interface SynthsETHBTCAbiInterface extends utils.Interface {
  functions: {
...
export interface SynthsETHBTCAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsETHBTCAbiInterface;
