...
export interface TokenStatesLINKAbiInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesLINKAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesLINKAbiInterface;
