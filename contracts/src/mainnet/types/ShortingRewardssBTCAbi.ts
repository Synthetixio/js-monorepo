...
export interface ShortingRewardssBTCAbiInterface extends utils.Interface {
  functions: {
...
export interface ShortingRewardssBTCAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ShortingRewardssBTCAbiInterface;
