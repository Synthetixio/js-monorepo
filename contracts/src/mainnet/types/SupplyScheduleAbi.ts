...
export interface SupplyScheduleAbiInterface extends utils.Interface {
  functions: {
...
export interface SupplyScheduleAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SupplyScheduleAbiInterface;
