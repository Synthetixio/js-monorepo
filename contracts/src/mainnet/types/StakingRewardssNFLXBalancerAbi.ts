...
export interface StakingRewardssNFLXBalancerAbiInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardssNFLXBalancerAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardssNFLXBalancerAbiInterface;
