...
export interface TokenStatesCHFAbiInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesCHFAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesCHFAbiInterface;
