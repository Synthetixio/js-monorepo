...
export interface StakingRewardssUSDCurveAbiInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardssUSDCurveAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardssUSDCurveAbiInterface;
