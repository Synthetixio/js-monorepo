...
export interface StakingRewardssMSFTBalancerAbiInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardssMSFTBalancerAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardssMSFTBalancerAbiInterface;
