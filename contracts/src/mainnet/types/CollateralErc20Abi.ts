...
export interface CollateralErc20AbiInterface extends utils.Interface {
  functions: {
...
export interface CollateralErc20Abi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CollateralErc20AbiInterface;
