...
export interface TokenStatesJPYAbiInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesJPYAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesJPYAbiInterface;
