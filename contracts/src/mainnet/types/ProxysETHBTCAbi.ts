...
export interface ProxysETHBTCAbiInterface extends utils.Interface {
  functions: {
...
export interface ProxysETHBTCAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxysETHBTCAbiInterface;
