...
export interface DelegateApprovalsEternalStorageAbiInterface extends utils.Interface {
  functions: {
...
export interface DelegateApprovalsEternalStorageAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DelegateApprovalsEternalStorageAbiInterface;
