...
export interface SynthetixBridgeEscrowAbiInterface extends utils.Interface {
  functions: {
...
export interface SynthetixBridgeEscrowAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthetixBridgeEscrowAbiInterface;
