...
export interface VirtualSynthMastercopyAbiInterface extends utils.Interface {
  functions: {
...
export interface VirtualSynthMastercopyAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VirtualSynthMastercopyAbiInterface;
