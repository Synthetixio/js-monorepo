...
export interface ExchangeStateAbiInterface extends utils.Interface {
  functions: {
...
export interface ExchangeStateAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ExchangeStateAbiInterface;
