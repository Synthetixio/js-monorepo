...
export interface StakingRewardsiBTCAbiInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardsiBTCAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardsiBTCAbiInterface;
