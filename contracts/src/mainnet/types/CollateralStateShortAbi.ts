...
export interface CollateralStateShortAbiInterface extends utils.Interface {
  functions: {
...
export interface CollateralStateShortAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CollateralStateShortAbiInterface;
