...
export interface OwnerRelayOnEthereumAbiInterface extends utils.Interface {
  functions: {
...
export interface OwnerRelayOnEthereumAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OwnerRelayOnEthereumAbiInterface;
