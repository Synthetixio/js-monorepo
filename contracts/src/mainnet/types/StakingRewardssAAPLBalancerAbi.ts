...
export interface StakingRewardssAAPLBalancerAbiInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardssAAPLBalancerAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardssAAPLBalancerAbiInterface;
