...
export interface CollateralStateErc20AbiInterface extends utils.Interface {
  functions: {
...
export interface CollateralStateErc20Abi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CollateralStateErc20AbiInterface;
