...
export interface TokenStatesKRWAbiInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesKRWAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesKRWAbiInterface;
