...
export interface TokenStatesGBPAbiInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesGBPAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesGBPAbiInterface;
