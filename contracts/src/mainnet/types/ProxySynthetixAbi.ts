...
export interface ProxySynthetixAbiInterface extends utils.Interface {
  functions: {
...
export interface ProxySynthetixAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxySynthetixAbiInterface;
