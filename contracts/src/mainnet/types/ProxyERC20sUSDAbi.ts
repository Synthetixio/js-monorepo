...
export interface ProxyERC20sUSDAbiInterface extends utils.Interface {
  functions: {
...
export interface ProxyERC20sUSDAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxyERC20sUSDAbiInterface;
