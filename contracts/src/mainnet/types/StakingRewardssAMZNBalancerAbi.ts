...
export interface StakingRewardssAMZNBalancerAbiInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardssAMZNBalancerAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardssAMZNBalancerAbiInterface;
