...
export interface StakingRewardssETHUniswapV1AbiInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardssETHUniswapV1Abi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardssETHUniswapV1AbiInterface;
