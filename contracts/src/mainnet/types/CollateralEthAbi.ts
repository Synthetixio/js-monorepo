...
export interface CollateralEthAbiInterface extends utils.Interface {
  functions: {
...
export interface CollateralEthAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CollateralEthAbiInterface;
