...
export interface TokenStatesADAAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesADAAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesADAAbiTypesInterface;
