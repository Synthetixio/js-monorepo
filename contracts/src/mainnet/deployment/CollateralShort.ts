...
export interface CollateralShortInterface extends utils.Interface {
  functions: {
    ...
    'getReward(bytes32,address)': FunctionFragment;
...
export interface CollateralShort extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CollateralShortInterface;
