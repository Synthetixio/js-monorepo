...
export const name = 'StakingRewardssCOINBalancer';
export const address = '0x1C1D97f6338759AB814a5A717aE359573Ab5D5d4';
...
export interface StakingRewardssCOINBalancerInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardssCOINBalancer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardssCOINBalancerInterface;
