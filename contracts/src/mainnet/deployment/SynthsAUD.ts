...
export interface SynthsAUDInterface extends utils.Interface {
  functions: {
...
export interface SynthsAUD extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsAUDInterface;
