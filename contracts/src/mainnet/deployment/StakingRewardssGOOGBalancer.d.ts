...
export interface StakingRewardssGOOGBalancerInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardssGOOGBalancer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardssGOOGBalancerInterface;
