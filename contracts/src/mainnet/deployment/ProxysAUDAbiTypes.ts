...
export interface ProxysAUDAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface ProxysAUDAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxysAUDAbiTypesInterface;
