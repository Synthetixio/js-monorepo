...
export interface StakingRewardsiETHInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardsiETH extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardsiETHInterface;
