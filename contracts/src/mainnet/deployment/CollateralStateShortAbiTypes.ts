...
export interface CollateralStateShortAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface CollateralStateShortAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CollateralStateShortAbiTypesInterface;
