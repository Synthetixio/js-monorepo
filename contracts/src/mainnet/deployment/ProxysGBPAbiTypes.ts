...
export interface ProxysGBPAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface ProxysGBPAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxysGBPAbiTypesInterface;
