...
export interface SynthsAAVEInterface extends utils.Interface {
  functions: {
...
export interface SynthsAAVE extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsAAVEInterface;
