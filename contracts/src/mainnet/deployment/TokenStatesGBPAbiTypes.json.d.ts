...
export interface TokenStatesGBPAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesGBPAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesGBPAbiTypesInterface;
