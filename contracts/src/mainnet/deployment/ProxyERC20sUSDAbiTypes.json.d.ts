...
export interface ProxyERC20sUSDAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface ProxyERC20sUSDAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxyERC20sUSDAbiTypesInterface;
