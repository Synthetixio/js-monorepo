...
export interface SynthsLINKAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface SynthsLINKAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsLINKAbiTypesInterface;
