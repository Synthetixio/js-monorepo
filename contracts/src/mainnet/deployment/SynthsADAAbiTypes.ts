...
export interface SynthsADAAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface SynthsADAAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsADAAbiTypesInterface;
