...
export interface StakingRewardssBTCCurveInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardssBTCCurve extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardssBTCCurveInterface;
