...
export interface CollateralStateErc20AbiTypesInterface extends utils.Interface {
  functions: {
...
export interface CollateralStateErc20AbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CollateralStateErc20AbiTypesInterface;
