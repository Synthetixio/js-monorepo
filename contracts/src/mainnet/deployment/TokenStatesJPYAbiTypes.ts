...
export interface TokenStatesJPYAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesJPYAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesJPYAbiTypesInterface;
