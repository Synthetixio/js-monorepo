...
export interface StakingRewardssFBBalancerAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardssFBBalancerAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardssFBBalancerAbiTypesInterface;
