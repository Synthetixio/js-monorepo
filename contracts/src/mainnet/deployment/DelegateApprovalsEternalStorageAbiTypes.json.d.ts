...
export interface DelegateApprovalsEternalStorageAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface DelegateApprovalsEternalStorageAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DelegateApprovalsEternalStorageAbiTypesInterface;
