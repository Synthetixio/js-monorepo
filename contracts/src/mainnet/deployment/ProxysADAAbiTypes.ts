...
export interface ProxysADAAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface ProxysADAAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxysADAAbiTypesInterface;
