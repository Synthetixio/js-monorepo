...
export interface IssuanceEternalStorageInterface extends utils.Interface {
  functions: {
...
export interface IssuanceEternalStorage extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IssuanceEternalStorageInterface;
