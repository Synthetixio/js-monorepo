...
export interface TokenStatesKRWAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesKRWAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesKRWAbiTypesInterface;
