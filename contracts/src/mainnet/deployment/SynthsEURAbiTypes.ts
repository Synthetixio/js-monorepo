...
export interface SynthsEURAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface SynthsEURAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsEURAbiTypesInterface;
