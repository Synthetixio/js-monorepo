...
export interface SynthsDOTInterface extends utils.Interface {
  functions: {
...
export interface SynthsDOT extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsDOTInterface;
