...
export interface TokenStatesLINKAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesLINKAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesLINKAbiTypesInterface;
