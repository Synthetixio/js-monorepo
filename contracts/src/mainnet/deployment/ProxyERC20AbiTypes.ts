...
export interface ProxyERC20AbiTypesInterface extends utils.Interface {
  functions: {
...
export interface ProxyERC20AbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxyERC20AbiTypesInterface;
