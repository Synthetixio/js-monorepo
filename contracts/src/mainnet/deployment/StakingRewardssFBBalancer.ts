...
export const name = 'StakingRewardssFBBalancer';
export const address = '0x26Fa0665660c1D3a3666584669511d3c66Ad37Cb';
...
export interface StakingRewardssFBBalancerInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardssFBBalancer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardssFBBalancerInterface;
