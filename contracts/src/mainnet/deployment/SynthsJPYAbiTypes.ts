...
export interface SynthsJPYAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface SynthsJPYAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsJPYAbiTypesInterface;
