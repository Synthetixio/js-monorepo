...
export interface ProxysDOTAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface ProxysDOTAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxysDOTAbiTypesInterface;
