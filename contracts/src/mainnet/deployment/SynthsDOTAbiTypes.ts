...
export interface SynthsDOTAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface SynthsDOTAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsDOTAbiTypesInterface;
