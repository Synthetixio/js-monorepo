...
export interface ProxysAAVEAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface ProxysAAVEAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxysAAVEAbiTypesInterface;
