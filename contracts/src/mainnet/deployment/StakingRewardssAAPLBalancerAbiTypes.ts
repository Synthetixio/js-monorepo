...
export interface StakingRewardssAAPLBalancerAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardssAAPLBalancerAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardssAAPLBalancerAbiTypesInterface;
