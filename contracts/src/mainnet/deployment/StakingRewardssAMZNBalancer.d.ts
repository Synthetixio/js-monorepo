...
export interface StakingRewardssAMZNBalancerInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardssAMZNBalancer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardssAMZNBalancerInterface;
