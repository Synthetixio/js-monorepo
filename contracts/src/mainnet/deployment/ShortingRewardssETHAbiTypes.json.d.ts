...
export interface ShortingRewardssETHAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface ShortingRewardssETHAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ShortingRewardssETHAbiTypesInterface;
