...
export interface ReadProxyAddressResolverAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface ReadProxyAddressResolverAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ReadProxyAddressResolverAbiTypesInterface;
