...
export interface ProxysEURAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface ProxysEURAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxysEURAbiTypesInterface;
