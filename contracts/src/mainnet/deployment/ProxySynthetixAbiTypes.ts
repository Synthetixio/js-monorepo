...
export interface ProxySynthetixAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface ProxySynthetixAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxySynthetixAbiTypesInterface;
