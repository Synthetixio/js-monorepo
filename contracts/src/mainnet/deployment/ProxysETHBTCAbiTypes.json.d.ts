...
export interface ProxysETHBTCAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface ProxysETHBTCAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxysETHBTCAbiTypesInterface;
