...
export interface SynthsKRWAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface SynthsKRWAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsKRWAbiTypesInterface;
