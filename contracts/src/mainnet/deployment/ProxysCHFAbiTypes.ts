...
export interface ProxysCHFAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface ProxysCHFAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxysCHFAbiTypesInterface;
