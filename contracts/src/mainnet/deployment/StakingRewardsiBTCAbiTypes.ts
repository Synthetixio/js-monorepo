...
export interface StakingRewardsiBTCAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardsiBTCAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardsiBTCAbiTypesInterface;
