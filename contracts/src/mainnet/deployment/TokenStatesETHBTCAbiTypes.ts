...
export interface TokenStatesETHBTCAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesETHBTCAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesETHBTCAbiTypesInterface;
