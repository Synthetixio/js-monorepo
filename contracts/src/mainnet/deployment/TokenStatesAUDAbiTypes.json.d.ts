...
export interface TokenStatesAUDAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesAUDAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesAUDAbiTypesInterface;
