...
export interface OneNetAggregatorsDEFIInterface extends utils.Interface {
  functions: {
...
export interface OneNetAggregatorsDEFI extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OneNetAggregatorsDEFIInterface;
