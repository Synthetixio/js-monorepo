...
export interface StakingRewardssETHUniswapV1AbiTypesInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardssETHUniswapV1AbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardssETHUniswapV1AbiTypesInterface;
