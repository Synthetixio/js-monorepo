...
export interface TokenStatesDOTAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesDOTAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesDOTAbiTypesInterface;
