...
export interface TokenStatesCHFAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesCHFAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesCHFAbiTypesInterface;
