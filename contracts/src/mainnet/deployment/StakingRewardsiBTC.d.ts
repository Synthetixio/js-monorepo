...
export interface StakingRewardsiBTCInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardsiBTC extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardsiBTCInterface;
