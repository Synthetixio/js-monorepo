...
export interface SignedSafeDecimalMathInterface extends utils.Interface {
  functions: {
...
export interface SignedSafeDecimalMath extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SignedSafeDecimalMathInterface;
