...
export interface StakingRewardssAAPLBalancerInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardssAAPLBalancer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardssAAPLBalancerInterface;
