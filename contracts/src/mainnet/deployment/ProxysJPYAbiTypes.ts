...
export interface ProxysJPYAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface ProxysJPYAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxysJPYAbiTypesInterface;
