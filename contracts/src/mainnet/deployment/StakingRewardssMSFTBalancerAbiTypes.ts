...
export interface StakingRewardssMSFTBalancerAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardssMSFTBalancerAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardssMSFTBalancerAbiTypesInterface;
