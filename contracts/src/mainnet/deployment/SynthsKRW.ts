...
export interface SynthsKRWInterface extends utils.Interface {
  functions: {
...
export interface SynthsKRW extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsKRWInterface;
