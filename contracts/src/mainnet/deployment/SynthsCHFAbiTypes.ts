...
export interface SynthsCHFAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface SynthsCHFAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsCHFAbiTypesInterface;
