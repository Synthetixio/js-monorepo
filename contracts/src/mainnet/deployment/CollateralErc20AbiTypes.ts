...
export interface CollateralErc20AbiTypesInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "maxLoansPerAccount",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "underlyingContract",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "underlyingContractDecimals",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export type MaxLoansPerAccountUpdatedEventFilter =
  TypedEventFilter<MaxLoansPerAccountUpdatedEvent>;
...
export type MinCratioRatioUpdatedEvent = TypedEvent<
  [BigNumber],
  MinCratioRatioUpdatedEventObject
>;

export type MinCratioRatioUpdatedEventFilter =
  TypedEventFilter<MinCratioRatioUpdatedEvent>;
...
export interface CollateralErc20AbiTypes extends BaseContract {
  ...
  filters: {
    ...
    "MinCratioRatioUpdated(uint256)"(
      minCratio?: null
    ): MinCratioRatioUpdatedEventFilter;
