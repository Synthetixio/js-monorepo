...
export interface CollateralStateErc20Interface extends utils.Interface {
  functions: {
...
export interface CollateralStateErc20 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CollateralStateErc20Interface;
