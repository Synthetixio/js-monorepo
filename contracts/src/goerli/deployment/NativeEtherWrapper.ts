...
export interface NativeEtherWrapperInterface extends utils.Interface {
  functions: {
...
export interface NativeEtherWrapper extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NativeEtherWrapperInterface;
