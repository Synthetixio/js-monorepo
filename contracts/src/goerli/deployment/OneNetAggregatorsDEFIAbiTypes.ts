...
export interface OneNetAggregatorsDEFIAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface OneNetAggregatorsDEFIAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OneNetAggregatorsDEFIAbiTypesInterface;
