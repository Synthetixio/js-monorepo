...
export interface ExchangeRatesAbiTypesInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "dexPriceAggregator",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export type DexPriceAggregatorUpdatedEventFilter =
  TypedEventFilter<DexPriceAggregatorUpdatedEvent>;
...
export interface ExchangeRatesAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ExchangeRatesAbiTypesInterface;
