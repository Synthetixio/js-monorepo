...
export interface SynthsETHAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface SynthsETHAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsETHAbiTypesInterface;
