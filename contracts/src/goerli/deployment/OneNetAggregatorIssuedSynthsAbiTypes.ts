...
export interface OneNetAggregatorIssuedSynthsAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface OneNetAggregatorIssuedSynthsAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OneNetAggregatorIssuedSynthsAbiTypesInterface;
