...
export interface TokenStateSynthetixAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface TokenStateSynthetixAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStateSynthetixAbiTypesInterface;
