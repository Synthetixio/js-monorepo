...
export interface SynthsBTCAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface SynthsBTCAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsBTCAbiTypesInterface;
