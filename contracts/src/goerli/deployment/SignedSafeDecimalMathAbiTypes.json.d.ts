...
export interface SignedSafeDecimalMathAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface SignedSafeDecimalMathAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SignedSafeDecimalMathAbiTypesInterface;
