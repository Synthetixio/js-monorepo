...
export interface OneNetAggregatorIssuedSynthsAbiInterface extends utils.Interface {
  functions: {
...
export interface OneNetAggregatorIssuedSynthsAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OneNetAggregatorIssuedSynthsAbiInterface;
