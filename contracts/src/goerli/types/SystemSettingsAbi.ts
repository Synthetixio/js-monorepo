...
export interface SystemSettingsAbiInterface extends utils.Interface {
  functions: {
...
export interface SystemSettingsAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SystemSettingsAbiInterface;
