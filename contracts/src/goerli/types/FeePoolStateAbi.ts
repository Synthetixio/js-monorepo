...
export interface FeePoolStateAbiInterface extends utils.Interface {
  functions: {
...
export interface FeePoolStateAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FeePoolStateAbiInterface;
