...
export interface CircuitBreakerAbiInterface extends utils.Interface {
  functions: {
...
export interface CircuitBreakerAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CircuitBreakerAbiInterface;
