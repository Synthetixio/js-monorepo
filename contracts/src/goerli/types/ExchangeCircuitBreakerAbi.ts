...
export interface ExchangeCircuitBreakerAbiInterface extends utils.Interface {
  functions: {
...
export interface ExchangeCircuitBreakerAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ExchangeCircuitBreakerAbiInterface;
