...
export interface ExchangeRatesAbiInterface extends utils.Interface {
  functions: {
...
export interface ExchangeRatesAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ExchangeRatesAbiInterface;
