...
export interface TradingRewardsAbiInterface extends utils.Interface {
  functions: {
...
export interface TradingRewardsAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TradingRewardsAbiInterface;
