...
export interface TokenStatesBTCAbiInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesBTCAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesBTCAbiInterface;
