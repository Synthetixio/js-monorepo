...
export interface SynthetixDebtShareAbiInterface extends utils.Interface {
  functions: {
...
export interface SynthetixDebtShareAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthetixDebtShareAbiInterface;
