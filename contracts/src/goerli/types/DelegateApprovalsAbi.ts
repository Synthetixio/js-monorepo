...
export interface DelegateApprovalsAbiInterface extends utils.Interface {
  functions: {
...
export interface DelegateApprovalsAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DelegateApprovalsAbiInterface;
