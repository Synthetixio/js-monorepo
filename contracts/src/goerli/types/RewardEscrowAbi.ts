...
export interface RewardEscrowAbiInterface extends utils.Interface {
  functions: {
...
export interface RewardEscrowAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RewardEscrowAbiInterface;
