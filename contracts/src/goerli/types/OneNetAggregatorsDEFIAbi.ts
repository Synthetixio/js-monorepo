...
export interface OneNetAggregatorsDEFIAbiInterface extends utils.Interface {
  functions: {
...
export interface OneNetAggregatorsDEFIAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OneNetAggregatorsDEFIAbiInterface;
