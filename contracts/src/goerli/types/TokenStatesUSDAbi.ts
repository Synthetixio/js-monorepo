...
export interface TokenStatesUSDAbiInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesUSDAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesUSDAbiInterface;
