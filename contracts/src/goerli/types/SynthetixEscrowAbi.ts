...
export interface SynthetixEscrowAbiInterface extends utils.Interface {
  functions: {
...
export interface SynthetixEscrowAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthetixEscrowAbiInterface;
