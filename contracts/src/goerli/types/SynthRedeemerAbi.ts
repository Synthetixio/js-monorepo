...
export interface SynthRedeemerAbiInterface extends utils.Interface {
  functions: {
...
export interface SynthRedeemerAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthRedeemerAbiInterface;
