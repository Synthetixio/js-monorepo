...
export interface SynthetixBridgeToOptimismAbiInterface extends utils.Interface {
  functions: {
...
export interface SynthetixBridgeToOptimismAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthetixBridgeToOptimismAbiInterface;
