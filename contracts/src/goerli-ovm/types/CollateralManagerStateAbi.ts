...
export interface CollateralManagerStateAbiInterface extends utils.Interface {
  functions: {
...
export interface CollateralManagerStateAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CollateralManagerStateAbiInterface;
