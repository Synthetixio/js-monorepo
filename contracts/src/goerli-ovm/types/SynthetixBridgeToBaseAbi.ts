...
export interface SynthetixBridgeToBaseAbiInterface extends utils.Interface {
  functions: {
...
export interface SynthetixBridgeToBaseAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthetixBridgeToBaseAbiInterface;
