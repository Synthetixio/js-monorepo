...
export interface FuturesMarketETHAbiInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketETHAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketETHAbiInterface;
