...
export interface WrapperFactoryAbiInterface extends utils.Interface {
  functions: {
...
export interface WrapperFactoryAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WrapperFactoryAbiInterface;
