...
export interface FuturesMarketBTCAbiInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketBTCAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketBTCAbiInterface;
