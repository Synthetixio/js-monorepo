...
export interface RewardsDistributionAbiInterface extends utils.Interface {
  functions: {
...
export interface RewardsDistributionAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RewardsDistributionAbiInterface;
