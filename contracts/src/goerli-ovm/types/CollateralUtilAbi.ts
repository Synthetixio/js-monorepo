...
export interface CollateralUtilAbiInterface extends utils.Interface {
  functions: {
...
export interface CollateralUtilAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CollateralUtilAbiInterface;
