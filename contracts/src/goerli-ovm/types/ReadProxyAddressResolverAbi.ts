...
export interface ReadProxyAddressResolverAbiInterface extends utils.Interface {
  functions: {
...
export interface ReadProxyAddressResolverAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ReadProxyAddressResolverAbiInterface;
