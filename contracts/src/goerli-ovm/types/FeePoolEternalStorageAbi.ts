...
export interface FeePoolEternalStorageAbiInterface extends utils.Interface {
  functions: {
...
export interface FeePoolEternalStorageAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FeePoolEternalStorageAbiInterface;
