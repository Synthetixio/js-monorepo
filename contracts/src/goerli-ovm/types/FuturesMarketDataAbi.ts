...
export interface FuturesMarketDataAbiInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketDataAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketDataAbiInterface;
