...
export interface TokenStatesETHAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesETHAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesETHAbiTypesInterface;
