...
export interface FuturesMarketETHAbiTypesInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketETHAbiTypes extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketETHAbiTypesInterface;
