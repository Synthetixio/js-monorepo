...
export const name = 'FuturesMarketXAG';
export const address = '0x89F36593eeD8807C43e81Ce7d633e15365274eeF';
...
export interface FuturesMarketXAGInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketXAG extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketXAGInterface;
