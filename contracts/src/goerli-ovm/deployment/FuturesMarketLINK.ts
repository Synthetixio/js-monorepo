...
export const name = 'FuturesMarketLINK';
export const address = '0x071171c2289b2Aef8F83eC50650f8eb91DbE44d2';
...
export interface FuturesMarketLINKInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketLINK extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketLINKInterface;
