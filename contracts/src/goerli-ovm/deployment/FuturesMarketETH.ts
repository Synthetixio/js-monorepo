...
export const name = 'FuturesMarketETH';
export const address = '0x0D10c032ad006C98C33A95e59ab3BA2b0849bD59';
...
export interface FuturesMarketETHInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketETH extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketETHInterface;
