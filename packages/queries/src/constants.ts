...
export const DEFAULT_SUBGRAPH_ENDPOINTS: { [networkId: number]: SubgraphEndpoints } = {
	1: {
		main: 'https://api.thegraph.com/subgraphs/name/synthetixio-team/mainnet-main',
	},

	10: {
		main: 'https://api.thegraph.com/subgraphs/name/synthetixio-team/optimism-main',
	},

	42: {
		main: 'https://api.thegraph.com/subgraphs/name/synthetixio-team/kovan-main',
	},

	69: {
		main: 'https://api.thegraph.com/subgraphs/name/synthetixio-team/optimism-kovan-main',
	},
};
