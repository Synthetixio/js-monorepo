...
export const getDailyExchangerById = async function <K extends keyof DailyExchangerResult>(
  url: string,
  options: SingleQueryOptions,
...
export const getDailyExchangers = async function <K extends keyof DailyExchangerResult>(
  url: string,
...
export const getDailySNXPriceById = async function <K extends keyof DailySNXPriceResult>(
  url: string,
  options: SingleQueryOptions,
...
export const getDailySNXPrices = async function <K extends keyof DailySNXPriceResult>(
  url: string,
...
export const getDailyTotalById = async function <K extends keyof DailyTotalResult>(
  url: string,
  options: SingleQueryOptions,
...
export const getDailyTotals = async function <K extends keyof DailyTotalResult>(
  url: string,
...
export const getFifteenMinuteExchangerById = async function <
  K extends keyof FifteenMinuteExchangerResult
>(
  url: string,
  options: SingleQueryOptions,
...
export const getFifteenMinuteExchangers = async function <
  K extends keyof FifteenMinuteExchangerResult
>(
  url: string,
...
export const getFifteenMinuteSNXPriceById = async function <
  K extends keyof FifteenMinuteSNXPriceResult
>(
  url: string,
  options: SingleQueryOptions,
...
export const getFifteenMinuteSNXPrices = async function <
  K extends keyof FifteenMinuteSNXPriceResult
>(
  url: string,
...
export const getFifteenMinuteTotalById = async function <K extends keyof FifteenMinuteTotalResult>(
  url: string,
  options: SingleQueryOptions,
...
export const getFifteenMinuteTotals = async function <K extends keyof FifteenMinuteTotalResult>(
  url: string,
...
export const getPostArchernarExchangerById = async function <
  K extends keyof PostArchernarExchangerResult
>(
  url: string,
  options: SingleQueryOptions,
...
export const getPostArchernarExchangers = async function <
  K extends keyof PostArchernarExchangerResult
>(
  url: string,
...
export const getPostArchernarTotalById = async function <K extends keyof PostArchernarTotalResult>(
  url: string,
  options: SingleQueryOptions,
...
export const getPostArchernarTotals = async function <K extends keyof PostArchernarTotalResult>(
  url: string,
