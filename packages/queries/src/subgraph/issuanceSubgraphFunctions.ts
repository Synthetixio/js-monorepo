...
export const getSynthHolderById = async function <K extends keyof SynthHolderResult>(
  url: string,
  options: SingleQueryOptions,
...
export const getSynthHolders = async function <K extends keyof SynthHolderResult>(
  url: string,
