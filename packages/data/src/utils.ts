...
export const requestHelper = async ({
	...
	if (prevOutput && prevOutput.length > 0) {
		...
		/**
		 * NOTE there is an error sometimes on the last request, which might not have any results,
		 *  so in this case I am returning hte results that have been returned so far
		 */
		// let newResponse = {};
		// try {
