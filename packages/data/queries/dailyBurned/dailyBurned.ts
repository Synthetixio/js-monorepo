...
export const createDailyBurnedQuery = (params?: BurnedQueryParams): string => {
	...
	return gql`
		query dailyBurneds($autoGeneratedPaginationField: Int, $minBlock: Int, $max: Int, $account: String) {
			dailyBurneds(
