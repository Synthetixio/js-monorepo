    ...
    <Box bg="navy.900" height="100%">
      <Container pt={12} pb={16} bg="navy.900" maxW="4xl" height="full">
        ...
        <Text fontSize="14px" my={2}>
          ...
          EXCLUSIONS THAT MIGHT APPLY TO YOU AND YOUR RIGHTS. PLEASE READ IT CAREFULLY. THESE TERMS
          REQUIRE THE USE OF ARBITRATION ON AN INDIVIDUAL BASIS TO RESOLVE DISPUTES, RATHER THAN
          JURY TRIALS OR CLASS ACTIONS. BY USING THE WEBSITE OR OUR SERVICES, YOU ACCEPT AND ARE
          BOUND BY THESE TERMS AND CONDITIONS. YOU MAY NOT USE OUR WEBSITE OR SERVICES IF YOU: (A)
          DO NOT AGREE TO THESE TERMS; (B) ARE NOT THE OLDER OF (i) AT LEAST EIGHTEEN (18) YEARS OF
          AGE; OR (ii) LEGAL AGE TO FORM A BINDING CONTRACT; OR (C) ARE PROHIBITED FROM ACCESSING OR
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            ...
            ), govern the User’s access to and use of https://synthetix.io/, https://synthetix.eth.limo/ and its sub-pages,
            including any content or functionality offered on or through the website-hosted user
            interface accessible via https://staking.synthetix.io/ or https://staking.synthetix.eth.limo/ (the{' '}
            <Text as="span" fontWeight="700">
              “Interface,”{' '}
            </Text>{' '}
            or collectively with other https://synthetix.io/ or https://synthetix.eth.limo/ subpages, the{' '}
            <Text as="span" fontWeight="700">
              “Website”
            </Text>
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            ...
            <Text>
              ...
              The User agrees that all information it provides to interact with the Website,
              Interface, Services, or otherwise, including, but not limited to, through the use of
              any interactive features on the Website is correct, current, and complete. The User
              consents to all actions we take with respect to the User’s information as is
            ...
            <Text mt={2}>
              ...
              information to any other person or entity. The User also acknowledges that any
              identity linked to its Web3 Utility is personal to the User and agrees not to provide
              any other person with access to such identity. The User also agrees to ensure that it
              will lock or otherwise prevent its Web3 Utility from unauthorized use on this Website
              or the Services at the end of each session. The User should use particular caution
              when accessing the Website or the Services from a public or shared computer so that
              others are not able to view or record the User’s username, password, private key, or
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            ...
            <Text mt={2}>
              ...
              objectionable interactions or activities after they have been executed. Accordingly,
              the User agrees that we assume no liability for any action or inaction regarding
              transmissions, communications, transactions, blockchain operations, or content
              provided by any Participant or third party, including any that may cause a malfunction
              or inaccuracy on the Website or among the Services. We have no liability or
              responsibility to anyone for any other party’s performance or nonperformance of the
              activities described in this Section, nor for any harms or damages created by others’
              interactions with any blockchain underlying the Services or reliance on the
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            ...
            related or interacting functionality (for example but without limitation, you may not
            use the foregoing marks to execute phishing attacks, spearphishing attacks, social
            engineering, or in any way that may cause a party to transmit crypto-assets to an
            unintended recipient or to reveal private information, like a private key or password).
            All other names, logos, product and service names, designs, and slogans on the Website
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            ...
            <Text mt={2}>
              ...
              with which it interacts via the Services.
            </Text>
          </Text>
        </Box>
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            ...
            through the Services may be out of date at any given time, and we are under no
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            ...
            <Text mt={2}>
              ...
              sufficient procedures and checkpoints to satisfy the User’s particular requirements
              for: (1) an appropriate Web3 Utility; (2) anti-virus protection and accuracy of data
              input and output; (3) its participation in and use of DeFi products, the protocol, and
            ...
            <Text mt={2}>
              ...
              EQUIPMENT, COMPUTER PROGRAMS, DATA, OR OTHER PROPRIETARY MATERIAL DUE TO THE USER’S
            ...
            <Text mt={2}>
              ...
              THE SERVICES IS ACCURATE, RELIABLE, COMPLETE, CONCISE, CURRENT, OR RELEVANT; (3) THAT
              THE WEBSITE, THE INTERFACE, THE SERVICES, OR ANY SOFTWARE CONTAINED THEREIN WILL BE
              FREE FROM DEFECTS, MALICIOUS SOFTWARE, ERRORS, OR ANY OTHER HARMFUL ELEMENTS, OR THAT
              ANY OF SUCH WILL BE CORRECTED; OR (4) THAT THE WEBSITE, THE INTERFACE, OR THE SERVICES
              WILL MEET THE USER’S EXPECTATIONS. NO INFORMATION OR STATEMENT THAT WE MAKE, INCLUDING
              DOCUMENTATION OR OUR PRIVATE COMMUNICATIONS, SHOULD BE TREATED AS OFFERING ANY
              WARRANTY CONCERNING THE WEBSITE, THE INTERFACE, OR THE SERVICES. WE DO NOT ENDORSE,
              GUARANTEE, OR ASSUME ANY LIABILITY OR RESPONSIBILITY FOR ANY CONTENT, ADVERTISEMENTS,
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            ...
            PROTOCOL, ANY WEBSITES LINKED THROUGH OUR SERVICES, ANY CONTENT ON THE WEBSITE OR SUCH
            ...
            DISCLAIMER OF LIABILITY EXTENDS TO ANY AND ALL DAMAGES CAUSED BY ANY THIRD PARTY
            (INCLUDING, WITHOUT LIMITATION, THOSE CAUSED BY FRAUD, DECEIPT, OR MANIPULATION),
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            ...
            social, and personal safety standpoints. The mere access to and interaction with
            blockchains requires high degrees of skill and knowledge to operate with a relative
            degree of safety and proficiency. Crypto-assets are highly volatile in nature due to
            many diverse factors, including without limitation use and adoption, speculation,
            manipulation, technology, security, and legal and regulatory developments and
            application. Further, the speed and cost of transacting with cryptographic technologies,
            such as blockchains like those underlying the Protocol, are variable and highly
            ...
            <Text mt={2}>
              ...
              (including without limitation any specific technical language used in this Agreement).
              The User further represents that it has all knowledge sufficient to work, and is
              informed of all foreseeable risks and the possibility of unforeseeable risks,
              associated with blockchains, crypto-assets, Web3 Utilities, smart contracts, the
              Interface, the Protocol, and the Services. The User further acknowledges, and assumes
              all risk related to the possibility, that any information presented via the Website,
              Interface, or Services may be inaccurate, possibly due to another party’s malicious
              activities and possibly to the User’s severe harm or detriment. The User agrees that
              we are not responsible for any of these or related risks, do not own or control any
              blockchain and that the Protocol itself is managed by a dispersed group of individual
              DAO contributors who cannot guarantee the safe or accurate functioning of the
              ...
              <Text as="span" fontWeight="700">
                ...
                in this Section or otherwise. The User further expressly waives and releases us from
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            ...
            financial advice). The User should not take or refrain from taking any action based on
            any information or content displayed or provided on the Website, on the Interface, or
            through the Services. The User should seek independent professional advice from an
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            ...
            User or any third party. Further, the User acknowledges and agrees to the fullest extent
            such duties or liabilities are afforded by law or by equity, those duties and
            liabilities are hereby irrevocably disclaimed, waived, and eliminated, and that we and
            any other Participant shall be held completely harmless in relation thereof. The User
            further agrees that the only duties and obligations that we or any Contributor owes the
            User, and the only rights the User has related to this Agreement or the User’s use of
            the Website or the Services, are those set out expressly in this Agreement or that
            cannot be waived by law. Further, the User agrees and understands that they are
            responsible for all applicable reporting requirements and deadlines, including taxes and
            relevant fees, and that we owe Users no affirmative duties with respect to said
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            ...
            other individuals’ errors or malfeasance. In most jurisdictions crypto-assets are not
            considered legal tender, and most crypto-assets are not backed by any government.
            Neither your crypto-asset balances nor any of your transactions via the Interface or
            Protocol are covered by Federal Deposit Insurance Corporation (FDIC), Securities
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            ...
            (including reasonable attorneys’ fees) arising out of or relating to: (1) the User’s
            violation of these Terms of Use; (2) the User’s use of the Website, the Services, or the
            Protocol, including, but not limited to, the User’s interactions with the Interface or
            other features which incorporate the Services, use of or reliance on the Website’s
            content, services, and products other than as expressly authorized in these Terms of
            Use; (3) the User’s use or reliance on of any information obtained from the Website; or
            (4) any other party’s access and use of the Website or Services with the User’s
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            ...
            invalidity, non-performance, or termination, shall be finally resolved by binding
            arbitration by the London Court of International Arbitration under its Rules of
        ...
        <Box my={6}>
          ...
          <Text mt={2} fontSize="14px">
            ...
            <Text mt={2}>
              ...
              provisions of these Terms of Use will continue in full force and effect.
            </Text>
          </Text>
        </Box>
        <Box my={6}>
