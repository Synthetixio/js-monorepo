...
const contracts = {
  ...
  sepolia: () => import('@synthetixio/contracts/build/sepolia/deployment/SynthetixDebtShare'),
  'sepolia-ovm': () =>
    import('@synthetixio/contracts/build/sepolia-ovm/deployment/SynthetixDebtShare'),
};
