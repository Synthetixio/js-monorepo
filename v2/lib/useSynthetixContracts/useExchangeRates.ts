...
const contracts = {
  ...
  sepolia: () => import('@synthetixio/contracts/build/sepolia/deployment/ExchangeRates'),
  'sepolia-ovm': () => import('@synthetixio/contracts/build/sepolia-ovm/deployment/ExchangeRates'),
};
