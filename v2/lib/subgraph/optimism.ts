...
export enum AtomicSynthExchange_OrderBy {
  Account = 'account',
  AccountBucketMagnitude = 'account__bucketMagnitude',
  AccountExchangeUsdTally = 'account__exchangeUSDTally',
  AccountFirstSeen = 'account__firstSeen',
  AccountId = 'account__id',
  AccountLastSeen = 'account__lastSeen',
  AccountPeriod = 'account__period',
  AccountTimestamp = 'account__timestamp',
  AccountTotalFeesGeneratedInUsd = 'account__totalFeesGeneratedInUSD',
  AccountTrades = 'account__trades',
  FeesInUsd = 'feesInUSD',
  FromAmount = 'fromAmount',
  FromAmountInUsd = 'fromAmountInUSD',
  FromSynth = 'fromSynth',
  FromSynthId = 'fromSynth__id',
  FromSynthName = 'fromSynth__name',
  FromSynthSymbol = 'fromSynth__symbol',
  FromSynthTotalSupply = 'fromSynth__totalSupply',
  GasPrice = 'gasPrice',
  Id = 'id',
  Timestamp = 'timestamp',
  ToAddress = 'toAddress',
  ...
  ToSynth = 'toSynth',
  ToSynthId = 'toSynth__id',
  ToSynthName = 'toSynth__name',
  ToSynthSymbol = 'toSynth__symbol',
  ToSynthTotalSupply = 'toSynth__totalSupply',
}
...
export enum Exchanger_OrderBy {
  ...
  Synth = 'synth',
  SynthId = 'synth__id',
  SynthName = 'synth__name',
  SynthSymbol = 'synth__symbol',
  SynthTotalSupply = 'synth__totalSupply',
  Timestamp = 'timestamp',
...
export enum ShortCollateralChange_OrderBy {
  ...
  IsDeposit = 'isDeposit',
  Short = 'short',
  ShortAccount = 'short__account',
  ShortAccruedInterestLastUpdateTimestamp = 'short__accruedInterestLastUpdateTimestamp',
  ShortClosedAt = 'short__closedAt',
  ShortCollateralLocked = 'short__collateralLocked',
  ShortCollateralLockedAmount = 'short__collateralLockedAmount',
  ShortCreatedAt = 'short__createdAt',
  ShortCreatedAtBlock = 'short__createdAtBlock',
  ShortId = 'short__id',
  ShortIsOpen = 'short__isOpen',
  ShortSynthBorrowed = 'short__synthBorrowed',
  ShortSynthBorrowedAmount = 'short__synthBorrowedAmount',
  ShortTxHash = 'short__txHash',
  Timestamp = 'timestamp',
}
...
export enum ShortContractUpdate_OrderBy {
  ...
  ContractDataCanOpenLoans = 'contractData__canOpenLoans',
  ContractDataId = 'contractData__id',
  ContractDataInteractionDelay = 'contractData__interactionDelay',
  ContractDataIssueFeeRate = 'contractData__issueFeeRate',
  ContractDataManager = 'contractData__manager',
  ContractDataMaxLoansPerAccount = 'contractData__maxLoansPerAccount',
  ContractDataMinCollateral = 'contractData__minCollateral',
  ContractDataMinCratio = 'contractData__minCratio',
  Field = 'field',
  Id = 'id',
  Timestamp = 'timestamp',
  Value = 'value',
