...
export const address = '0xC6fEa2a12a8a9e11232b18DC4d9D525F02180247';
...
export interface ExchangeRatesInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: 'setDexPriceAggregator',
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export type DexPriceAggregatorUpdatedEvent = TypedEvent<
  [string],
  DexPriceAggregatorUpdatedEventObject
>;
...
export interface ExchangeRates extends BaseContract {
  ...
  filters: {
    ...
    'DexPriceAggregatorUpdated(address)'(
      newDexPriceAggregator?: null
    ): DexPriceAggregatorUpdatedEventFilter;
