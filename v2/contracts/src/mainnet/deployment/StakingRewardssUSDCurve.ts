...
export const name = 'StakingRewardssUSDCurve';
export const address = '0xDCB6A51eA3CA5d3Fd898Fd6564757c7aAeC3ca92';
export const source = 'StakingRewardssUSDCurve';
export const abi = [
...
export interface StakingRewardssUSDCurveInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardssUSDCurve extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardssUSDCurveInterface;
