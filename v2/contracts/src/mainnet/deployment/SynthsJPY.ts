...
export interface SynthsJPYInterface extends utils.Interface {
  functions: {
...
export interface SynthsJPY extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsJPYInterface;
