...
export interface TokenStatesETHBTCInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesETHBTC extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesETHBTCInterface;
