...
export const address = '0x5c8344bcdC38F1aB5EB5C1d4a35DdEeA522B5DfA';
...
export interface CollateralEthInterface extends utils.Interface {
  functions: {
...
export interface CollateralEth extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CollateralEthInterface;
