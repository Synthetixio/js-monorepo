...
export const name = 'StakingRewardssEURCurve';
export const address = '0xc0d8994Cd78eE1980885DF1A0C5470fC977b5cFe';
...
export interface StakingRewardssEURCurveInterface extends utils.Interface {
  functions: {
...
export interface StakingRewardssEURCurve extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardssEURCurveInterface;
