...
export const name = 'StakingRewardssETHUniswapV1';
export const address = '0x48D7f315feDcaD332F68aafa017c7C158BC54760';
export const source = 'StakingRewardssETHUniswapV1';
export const abi = [
...
export interface StakingRewardssETHUniswapV1Interface extends utils.Interface {
  functions: {
...
export interface StakingRewardssETHUniswapV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakingRewardssETHUniswapV1Interface;
