...
export interface SynthsGBPInterface extends utils.Interface {
  functions: {
...
export interface SynthsGBP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsGBPInterface;
