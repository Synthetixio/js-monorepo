...
export const address = '0xab4688E54A216aB3813438D30603Bf855648AF8d';
...
export interface IssuerInterface extends utils.Interface {
  functions: {
    ...
    'burnAndIssueSynthsWithoutDebtCache(address,bytes32,uint256,uint256)': FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: 'burnAndIssueSynthsWithoutDebtCache',
    values: [
...
export interface Issuer extends BaseContract {
  ...
  functions: {
    ...
    burnAndIssueSynthsWithoutDebtCache(
      ...
      amountInsUSD: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
