...
export const address = '0x416F47bB7c5abc848603Da2C4C505AF8e338B873';
...
export interface PerpsV2MarketLiquidateXLMPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateXLMPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateXLMPERPInterface;
