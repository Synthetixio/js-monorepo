...
export const address = '0x95141EAa3891af731c81a6797098bD21B5cc185F';
...
export interface PerpsV2MarketXTZPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketXTZPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketXTZPERPInterface;
