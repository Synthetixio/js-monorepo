...
export const name = 'PerpsV2MarketStatePYTHPERP';
export const address = '0xb9d93F93b4Cd5fb2Cc015f6C88438Ed0E028727f';
...
export interface PerpsV2MarketStatePYTHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStatePYTHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStatePYTHPERPInterface;
