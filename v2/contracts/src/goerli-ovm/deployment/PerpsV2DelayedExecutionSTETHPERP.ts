...
export const address = '0x9502CeD8D03497C76db8eeE779aCaD98245aC945';
...
export interface PerpsV2DelayedExecutionSTETHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionSTETHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionSTETHPERPInterface;
