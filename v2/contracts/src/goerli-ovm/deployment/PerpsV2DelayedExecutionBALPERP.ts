...
export const address = '0xa37cfA9E6d690d3A2B691c3a77bA082644388Ec4';
...
export interface PerpsV2DelayedExecutionBALPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionBALPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionBALPERPInterface;
