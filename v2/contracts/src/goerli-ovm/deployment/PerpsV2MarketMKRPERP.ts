...
export const address = '0x8ed0F38D2634BF6B966f1D6125641c35d0206fd3';
...
export interface PerpsV2MarketMKRPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketMKRPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketMKRPERPInterface;
