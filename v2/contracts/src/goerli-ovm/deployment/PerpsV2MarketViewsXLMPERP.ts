...
export const name = 'PerpsV2MarketViewsXLMPERP';
export const address = '0x430f7BeA08BA53FA8a8A641bB887cEF325f80EBC';
...
export interface PerpsV2MarketViewsXLMPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsXLMPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsXLMPERPInterface;
