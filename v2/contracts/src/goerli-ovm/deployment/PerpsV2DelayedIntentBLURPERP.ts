...
export const address = '0xA13a71991C177889619787b912E82aa5f91c5607';
...
export interface PerpsV2DelayedIntentBLURPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentBLURPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentBLURPERPInterface;
