...
export const address = '0x27e14b1d22a1F029e9f765e2aCb9DA026695225f';
...
export interface PerpsV2DelayedExecutionNEARPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionNEARPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionNEARPERPInterface;
