...
export const address = '0x6BC62823A1865ec35a32BcBc045369592c9Ef584';
...
export interface PerpsV2DelayedExecutionCOMPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionCOMPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionCOMPPERPInterface;
