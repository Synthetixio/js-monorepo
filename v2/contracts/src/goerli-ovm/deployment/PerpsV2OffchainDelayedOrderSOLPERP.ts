...
export const name = 'PerpsV2OffchainDelayedOrderSOLPERP';
export const address = '0x4967d1987930b2CD183dAB4B6C40B8745DD2eba1';
...
export interface PerpsV2OffchainDelayedOrderSOLPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2OffchainDelayedOrderSOLPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2OffchainDelayedOrderSOLPERPInterface;
