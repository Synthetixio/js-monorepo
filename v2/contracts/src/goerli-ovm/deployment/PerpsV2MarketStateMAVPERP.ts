...
export const name = 'PerpsV2MarketStateMAVPERP';
export const address = '0x4d69878cF675501C413534C183A79d5c0f8ccA6c';
...
export interface PerpsV2MarketStateMAVPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateMAVPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateMAVPERPInterface;
