...
export const address = '0xeBBF262CBF76BD434873C278C05249A863ed93f3';
...
export interface PerpsV2ProxyZILPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyZILPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyZILPERPInterface;
