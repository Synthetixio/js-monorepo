...
export const name = 'PerpsV2MarketStateICPPERP';
export const address = '0x94EC95591D347C6865402e72C503E2E58b3adFd2';
...
export interface PerpsV2MarketStateICPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateICPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateICPPERPInterface;
