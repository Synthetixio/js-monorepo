...
export const name = 'PerpsV2MarketViewsKNCPERP';
export const address = '0xf4b110E5006A4Cb9615BD520Ed6a82b0aB0e5649';
...
export interface PerpsV2MarketViewsKNCPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsKNCPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsKNCPERPInterface;
