...
export const address = '0xeff373efBD352531F680575796AE14764bE0391B';
...
export interface PerpsV2ProxyAPEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyAPEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyAPEPERPInterface;
