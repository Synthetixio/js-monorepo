...
export const name = 'PerpsV2DelayedOrderAAVEPERP';
export const address = '0x3FF85EdC96341924a43950ecfaEfA52a4342aB56';
...
export interface PerpsV2DelayedOrderAAVEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedOrderAAVEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedOrderAAVEPERPInterface;
