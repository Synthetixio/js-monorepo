...
export const name = 'PerpsV2MarketStateONEPERP';
export const address = '0x480CB2fD05cce27d01a9024263b13cB5A864885E';
...
export interface PerpsV2MarketStateONEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateONEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateONEPERPInterface;
