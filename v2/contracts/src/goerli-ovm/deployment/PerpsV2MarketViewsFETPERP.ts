...
export const name = 'PerpsV2MarketViewsFETPERP';
export const address = '0xD5225DE47F9953bb810b3B36E534A881355e0302';
...
export interface PerpsV2MarketViewsFETPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsFETPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsFETPERPInterface;
