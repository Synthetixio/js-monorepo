...
export const address = '0x3930Ee82B38a0023Dc695424059Ad63b1220f987';
...
export interface PerpsV2MarketLiquidateBALPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateBALPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateBALPERPInterface;
