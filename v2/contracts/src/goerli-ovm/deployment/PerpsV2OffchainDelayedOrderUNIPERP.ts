...
export const name = 'PerpsV2OffchainDelayedOrderUNIPERP';
export const address = '0x0e9A31335A17a7Da18989753290aA1199ECfe89f';
...
export interface PerpsV2OffchainDelayedOrderUNIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2OffchainDelayedOrderUNIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2OffchainDelayedOrderUNIPERPInterface;
