...
export const address = '0x9c8D4421055f568f6e25695F74aF63f82fBd8314';
...
export interface PerpsV2DelayedIntentWLDPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentWLDPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentWLDPERPInterface;
