...
export const address = '0xAEB7C3F9e9D49b7f23EBCc15cF095bc2b4d8A6C7';
...
export interface PerpsV2DelayedExecutionBTCPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionBTCPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionBTCPERPInterface;
