...
export const address = '0x662Ce20c34f9Eff955bADbdcFA7641D095a96252';
...
export interface PerpsV2ProxyGMXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyGMXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyGMXPERPInterface;
