...
export const address = '0x18D94F5dAacFC1D188e62BD4773dD1b300B4d2a3';
...
export interface PerpsV2MarketXAGPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketXAGPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketXAGPERPInterface;
