...
export const name = 'PerpsV2MarketViewsANKRPERP';
export const address = '0xD5988940476a42aBc090Cf144d744686a9277F0B';
...
export interface PerpsV2MarketViewsANKRPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsANKRPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsANKRPERPInterface;
