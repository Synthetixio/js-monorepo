...
export const address = '0xd94FA17aA3907F796D002F265a79D0945afaC283';
...
export interface PerpsV2DelayedExecutionSUSHIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionSUSHIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionSUSHIPERPInterface;
