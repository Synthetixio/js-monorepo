...
export const address = '0x1455B8D6E727e71995e638166394A79aD2AC3558';
...
export interface PerpsV2ProxyRNDRPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyRNDRPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyRNDRPERPInterface;
