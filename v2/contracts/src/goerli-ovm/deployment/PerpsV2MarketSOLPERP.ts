...
export const address = '0xE0179180a836AE2e14600a34742BDAfb49de4dC4';
...
export interface PerpsV2MarketSOLPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketSOLPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketSOLPERPInterface;
