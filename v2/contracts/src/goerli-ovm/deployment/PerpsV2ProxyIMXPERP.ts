...
export const address = '0xc5FD2e24d3fC3b2fD290157Cb7b4e1CCdbE3E12A';
...
export interface PerpsV2ProxyIMXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyIMXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyIMXPERPInterface;
