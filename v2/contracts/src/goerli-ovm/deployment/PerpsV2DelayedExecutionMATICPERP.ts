...
export const address = '0x33476b5F9d08B72D20e286841533d6fC8d302362';
...
export interface PerpsV2DelayedExecutionMATICPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionMATICPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionMATICPERPInterface;
