...
export const address = '0x16118826a89Ed49F1F23E66dC6899EFf1A712c78';
...
export interface PerpsV2MarketLiquidateAXSPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateAXSPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateAXSPERPInterface;
