...
export const address = '0xc98bD33EA81411FF0De0e66A6f1ad24803b41C38';
...
export interface PerpsV2MarketViewsZILPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsZILPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsZILPERPInterface;
