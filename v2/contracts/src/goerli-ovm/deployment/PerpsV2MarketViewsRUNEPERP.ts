...
export const name = 'PerpsV2MarketViewsRUNEPERP';
export const address = '0x974Eb9322f5319079fcebF61D577D16A50b5519d';
...
export interface PerpsV2MarketViewsRUNEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsRUNEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsRUNEPERPInterface;
