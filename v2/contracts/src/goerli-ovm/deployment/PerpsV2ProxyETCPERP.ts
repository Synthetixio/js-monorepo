...
export const address = '0x2FBB6cbe38889Dd11b7759C890079396e2e58334';
...
export interface PerpsV2ProxyETCPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyETCPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyETCPERPInterface;
