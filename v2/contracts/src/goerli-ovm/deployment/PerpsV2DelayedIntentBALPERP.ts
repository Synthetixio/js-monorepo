...
export const address = '0xEba53E02390Cc81b6Ba4C63c925beeb869bECFdE';
...
export interface PerpsV2DelayedIntentBALPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentBALPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentBALPERPInterface;
