...
export const address = '0x56fbEED46d7B53D7975f32156BccB70c67acFF01';
...
export interface PerpsV2MarketTIAPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketTIAPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketTIAPERPInterface;
