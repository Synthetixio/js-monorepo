...
export const name = 'PerpsV2OffchainDelayedOrderBTCPERP';
export const address = '0x9335fAb54147265A4Cce5333455adceA2b241194';
...
export interface PerpsV2OffchainDelayedOrderBTCPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2OffchainDelayedOrderBTCPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2OffchainDelayedOrderBTCPERPInterface;
