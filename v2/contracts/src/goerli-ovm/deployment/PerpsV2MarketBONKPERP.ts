...
export const address = '0xFef557fAAA5b94F854fc49159De697B83364D2ed';
...
export interface PerpsV2MarketBONKPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketBONKPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketBONKPERPInterface;
