...
export const name = 'PerpsV2MarketStateEURPERP';
export const address = '0xEB6a3a7d38Cd37Cf8ef2158c247249e6809ede2c';
...
export interface PerpsV2MarketStateEURPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateEURPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateEURPERPInterface;
