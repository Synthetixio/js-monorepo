...
export const address = '0x28991236B201CF2132F0BFEF4adFeD4B2B0B6421';
...
export interface PerpsV2MarketLiquidateANKRPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateANKRPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateANKRPERPInterface;
