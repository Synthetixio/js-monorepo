...
export const name = 'PerpsV2MarketStateADAPERP';
export const address = '0x2137267cD09B38999BFf146f4F01B3908b9967CD';
...
export interface PerpsV2MarketStateADAPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateADAPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateADAPERPInterface;
