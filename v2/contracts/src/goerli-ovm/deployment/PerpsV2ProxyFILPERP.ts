...
export const address = '0xEC9AB8399E4Ba4fcb7E03A6cc5d5Dd485b72fC85';
...
export interface PerpsV2ProxyFILPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyFILPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyFILPERPInterface;
