...
export const address = '0xeae543846E99e4Eb7525bD7ac1437116fbBE0C73';
...
export interface PerpsV2MarketARBPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketARBPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketARBPERPInterface;
