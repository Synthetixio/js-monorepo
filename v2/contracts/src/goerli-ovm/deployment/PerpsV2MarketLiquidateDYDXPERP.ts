...
export const address = '0x175e6253535e543d6324D2823078A202d4935524';
...
export interface PerpsV2MarketLiquidateDYDXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateDYDXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateDYDXPERPInterface;
