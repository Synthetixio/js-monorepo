...
export const address = '0x2e942f76516ff18BA4036E2E4516193d11D96F1f';
...
export interface PerpsV2DelayedExecutionLDOPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionLDOPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionLDOPERPInterface;
