...
export const name = 'PerpsV2MarketStateSTETHPERP';
export const address = '0xB9FbE7647dA76791b07285e5a082dB4B94b9E457';
...
export interface PerpsV2MarketStateSTETHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateSTETHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateSTETHPERPInterface;
