...
export const address = '0xf1c22c967FF7387a91322685be8aB4B3D2f34569';
...
export interface PerpsV2MarketLiquidateAUDPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateAUDPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateAUDPERPInterface;
