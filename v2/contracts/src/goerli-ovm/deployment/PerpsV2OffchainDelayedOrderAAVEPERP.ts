...
export const name = 'PerpsV2OffchainDelayedOrderAAVEPERP';
export const address = '0xf3c60f60Ee2F981f107B6E19c784653dAe912bdd';
...
export interface PerpsV2OffchainDelayedOrderAAVEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2OffchainDelayedOrderAAVEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2OffchainDelayedOrderAAVEPERPInterface;
