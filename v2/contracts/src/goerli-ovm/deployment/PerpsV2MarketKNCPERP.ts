...
export const address = '0xca942ab49C430F2eC0A603DADa0112b624dee79E';
...
export interface PerpsV2MarketKNCPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketKNCPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketKNCPERPInterface;
