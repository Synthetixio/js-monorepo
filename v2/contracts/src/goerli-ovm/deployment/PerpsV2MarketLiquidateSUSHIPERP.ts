...
export const address = '0x1A596A95158E2bAB50AebCC5F6a6f90469e5ED5C';
...
export interface PerpsV2MarketLiquidateSUSHIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateSUSHIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateSUSHIPERPInterface;
