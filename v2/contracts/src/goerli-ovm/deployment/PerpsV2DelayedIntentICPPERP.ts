...
export const address = '0x32c0E52Df110847D1fC476bc7991742fBf6DCf25';
...
export interface PerpsV2DelayedIntentICPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentICPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentICPPERPInterface;
