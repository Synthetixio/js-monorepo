...
export const address = '0x4Ce0D35AcE88e88599b3ca5DC613029D6240274d';
...
export interface PerpsV2OffchainDelayedOrderETHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2OffchainDelayedOrderETHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2OffchainDelayedOrderETHPERPInterface;
