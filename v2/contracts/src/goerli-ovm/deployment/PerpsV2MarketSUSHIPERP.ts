...
export const address = '0xE996f47c177E5248FD2060C5eAb392a4f4a789C6';
...
export interface PerpsV2MarketSUSHIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketSUSHIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketSUSHIPERPInterface;
