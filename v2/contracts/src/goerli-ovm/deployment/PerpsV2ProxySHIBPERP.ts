...
export const address = '0xBF0dEA3A088bAdd3A40ef8A0C5F148CDB686AA6F';
...
export interface PerpsV2ProxySHIBPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxySHIBPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxySHIBPERPInterface;
