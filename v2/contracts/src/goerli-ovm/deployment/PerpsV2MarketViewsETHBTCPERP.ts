...
export const name = 'PerpsV2MarketViewsETHBTCPERP';
export const address = '0xb541A602D3a4BfA719B7c16369fFa134fAd4e244';
...
export interface PerpsV2MarketViewsETHBTCPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsETHBTCPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsETHBTCPERPInterface;
