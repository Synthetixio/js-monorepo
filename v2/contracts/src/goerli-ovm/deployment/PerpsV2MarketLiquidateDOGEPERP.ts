...
export const address = '0xB4F217A4cCe2D3FBBd24a7BAa2D946019b4898C1';
...
export interface PerpsV2MarketLiquidateDOGEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateDOGEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateDOGEPERPInterface;
