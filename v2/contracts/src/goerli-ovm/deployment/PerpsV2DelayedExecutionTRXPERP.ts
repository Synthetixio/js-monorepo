...
export const address = '0x696AD452Db38B46F41B2a590292e3B0b11d86145';
...
export interface PerpsV2DelayedExecutionTRXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionTRXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionTRXPERPInterface;
