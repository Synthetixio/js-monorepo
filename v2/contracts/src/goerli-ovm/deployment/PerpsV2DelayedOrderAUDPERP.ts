...
export const name = 'PerpsV2DelayedOrderAUDPERP';
export const address = '0x628D012b3714702a024317584194b6b6831Cd5eB';
...
export interface PerpsV2DelayedOrderAUDPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedOrderAUDPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedOrderAUDPERPInterface;
