...
export const address = '0x0Ee2c2E01072c5Fa866BB3372Fe81698FB3165bA';
...
export interface FuturesMarketXMRInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketXMR extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketXMRInterface;
