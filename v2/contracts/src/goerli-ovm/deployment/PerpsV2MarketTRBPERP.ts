...
export const address = '0x8087dd5DbCD5D73140B229Df70bB71D6688e5e88';
...
export interface PerpsV2MarketTRBPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketTRBPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketTRBPERPInterface;
