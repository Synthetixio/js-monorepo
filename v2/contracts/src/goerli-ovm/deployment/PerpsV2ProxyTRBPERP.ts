...
export const address = '0x9517C4DD0e7f58Bc252c1E904a788b0FD70B91b9';
...
export interface PerpsV2ProxyTRBPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyTRBPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyTRBPERPInterface;
