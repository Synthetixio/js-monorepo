...
export const address = '0xF1c1862101916d19d3EF7721B09f02854EAc1266';
...
export interface PerpsV2ProxyCRVPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyCRVPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyCRVPERPInterface;
