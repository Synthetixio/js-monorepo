...
export const name = 'PerpsV2DelayedOrderAVAXPERP';
export const address = '0xC70acc95C8b816433d3650E2b8E0c0B40e2Cfd0E';
...
export interface PerpsV2DelayedOrderAVAXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedOrderAVAXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedOrderAVAXPERPInterface;
