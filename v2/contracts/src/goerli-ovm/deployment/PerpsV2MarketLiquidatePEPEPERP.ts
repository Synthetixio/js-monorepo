...
export const address = '0x2A7caF7B48B95Ee958B0a1C67e32C257287B6251';
...
export interface PerpsV2MarketLiquidatePEPEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidatePEPEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidatePEPEPERPInterface;
