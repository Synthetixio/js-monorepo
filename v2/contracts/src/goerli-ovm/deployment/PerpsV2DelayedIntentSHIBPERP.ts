...
export const address = '0xa8702F1428a320B20aDf243B579Be6BA94Ea423d';
...
export interface PerpsV2DelayedIntentSHIBPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentSHIBPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentSHIBPERPInterface;
