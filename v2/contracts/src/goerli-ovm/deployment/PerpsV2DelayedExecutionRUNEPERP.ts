...
export const address = '0xb87266D77d395ff146F68bC41F2Be72a765bF417';
...
export interface PerpsV2DelayedExecutionRUNEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionRUNEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionRUNEPERPInterface;
