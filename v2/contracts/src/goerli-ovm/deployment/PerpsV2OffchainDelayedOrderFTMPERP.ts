...
export const name = 'PerpsV2OffchainDelayedOrderFTMPERP';
...
export interface PerpsV2OffchainDelayedOrderFTMPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2OffchainDelayedOrderFTMPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2OffchainDelayedOrderFTMPERPInterface;
