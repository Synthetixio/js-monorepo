...
export const address = '0x28C9691E5Db7fE4a8786Df08592f4A2C80208410';
...
export interface PerpsV2MarketLiquidateBLURPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateBLURPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateBLURPERPInterface;
