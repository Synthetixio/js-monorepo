...
export const name = 'PerpsV2MarketViewsGRTPERP';
export const address = '0xCb1fAcc112EF56d0363b5e0C7D4DB7ef1615A34E';
...
export interface PerpsV2MarketViewsGRTPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsGRTPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsGRTPERPInterface;
