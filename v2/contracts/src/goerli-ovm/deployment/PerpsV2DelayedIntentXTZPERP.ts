...
export const address = '0xd74d3DEBfB5EBDe3daB36aaB992dCBa142425bE5';
...
export interface PerpsV2DelayedIntentXTZPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentXTZPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentXTZPERPInterface;
