...
export const address = '0x0f5976ac00143903Bb20a13Bee2BB3537f98EE85';
...
export interface PerpsV2MarketEURPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketEURPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketEURPERPInterface;
