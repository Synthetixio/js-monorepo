...
export const name = 'PerpsV2MarketViewsFILPERP';
export const address = '0xbbBa72bb1F3e85BED842F37DA579d3506db57E1D';
...
export interface PerpsV2MarketViewsFILPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsFILPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsFILPERPInterface;
