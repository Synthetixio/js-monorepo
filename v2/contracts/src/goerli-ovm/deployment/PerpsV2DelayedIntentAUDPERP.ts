...
export const address = '0x19c4D35bB6cA87833c156B9dC4031bCcaD403C72';
...
export interface PerpsV2DelayedIntentAUDPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentAUDPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentAUDPERPInterface;
