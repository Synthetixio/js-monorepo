...
export const name = 'PerpsV2OffchainDelayedOrderFLOWPERP';
export const address = '0xd1210dDA1b9b9c667e6FCCb0C09bC36De6B48B8b';
...
export interface PerpsV2OffchainDelayedOrderFLOWPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2OffchainDelayedOrderFLOWPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2OffchainDelayedOrderFLOWPERPInterface;
