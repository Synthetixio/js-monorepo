...
export const address = '0x71cf06D18286086f858d27Cd5c790b1D1e7867fb';
...
export interface PerpsV2DelayedExecutionALGOPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionALGOPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionALGOPERPInterface;
