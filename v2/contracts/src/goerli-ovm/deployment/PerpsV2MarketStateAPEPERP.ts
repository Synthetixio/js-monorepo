...
export const name = 'PerpsV2MarketStateAPEPERP';
export const address = '0xabE0b70033Da709a1a2ECF78CcbB6649A997199b';
...
export interface PerpsV2MarketStateAPEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateAPEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateAPEPERPInterface;
