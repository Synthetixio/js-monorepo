...
export const address = '0x843E61b441f9c7Da31495227F9914B9053f2A043';
...
export interface PerpsV2ProxyWLDPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyWLDPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyWLDPERPInterface;
