...
export const address = '0xf63e350E20084e172964009C660C58e480fdeEE6';
...
export interface PerpsV2DelayedExecutionPYTHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionPYTHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionPYTHPERPInterface;
