...
export const address = '0xD7FD95a46015fb023DF78e7426E5a9423bE7586f';
...
export interface PerpsV2MarketLiquidateXRPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateXRPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateXRPPERPInterface;
