...
export const name = 'PerpsV2MarketViewsPEPEPERP';
export const address = '0xed536607DEb0528547c0C0903c943C1e85345a0e';
...
export interface PerpsV2MarketViewsPEPEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsPEPEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsPEPEPERPInterface;
