...
export const address = '0xB0bda3a5A58265a3689F37e96B34420A8A5B8C49';
...
export interface PerpsV2MarketLiquidateJTOPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateJTOPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateJTOPERPInterface;
