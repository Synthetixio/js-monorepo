...
export const address = '0xE327b5FdAdAbC6706DF88784f01484b8aF9DDf94';
...
export interface PerpsV2DelayedIntentZILPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentZILPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentZILPERPInterface;
