...
export const name = 'PerpsV2MarketViewsUMAPERP';
export const address = '0x135F50dA290B5c564290Eea198aeDF55595af110';
...
export interface PerpsV2MarketViewsUMAPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsUMAPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsUMAPERPInterface;
