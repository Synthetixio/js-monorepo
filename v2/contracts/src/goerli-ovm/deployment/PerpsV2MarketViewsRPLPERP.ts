...
export const name = 'PerpsV2MarketViewsRPLPERP';
export const address = '0x7E2282418f355f56986cC85270E87315633Dca93';
...
export interface PerpsV2MarketViewsRPLPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsRPLPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsRPLPERPInterface;
