...
export const address = '0x8Ad4AC595dEE062aA9Cc0EAbA2427C8B588e048A';
...
export interface PerpsV2DelayedExecutionAUDPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionAUDPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionAUDPERPInterface;
