...
export const address = '0x6B9Fd085aDd231286f00877a13A55D40088Ee16A';
...
export interface PerpsV2DelayedExecutionADAPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionADAPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionADAPERPInterface;
