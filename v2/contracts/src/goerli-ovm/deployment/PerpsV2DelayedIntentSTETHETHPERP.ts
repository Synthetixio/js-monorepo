...
export const address = '0xff5DccD450FadaEF677D87f0812030b48373CF03';
...
export interface PerpsV2DelayedIntentSTETHETHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentSTETHETHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentSTETHETHPERPInterface;
