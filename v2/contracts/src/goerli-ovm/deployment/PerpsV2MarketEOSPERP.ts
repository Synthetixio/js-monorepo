...
export const address = '0x7cd55bbb5c4fe28f5a210161E86364D85Df0Ad9d';
...
export interface PerpsV2MarketEOSPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketEOSPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketEOSPERPInterface;
