...
export const address = '0x8B7e7A85D5DE5a6a7664ce6256e98826E041dF71';
...
export interface PerpsV2MarketMATICPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketMATICPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketMATICPERPInterface;
