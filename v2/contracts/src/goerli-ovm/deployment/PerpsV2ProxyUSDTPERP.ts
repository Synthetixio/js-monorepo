...
export const address = '0x90cCe6Ea3c6CE1280A679E2c0007A2bA4Ae0E31F';
...
export interface PerpsV2ProxyUSDTPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyUSDTPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyUSDTPERPInterface;
