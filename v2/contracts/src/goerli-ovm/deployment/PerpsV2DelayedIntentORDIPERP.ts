...
export const address = '0x5dbA0028A826395bc748e97fde8C6e4398dD0fc8';
...
export interface PerpsV2DelayedIntentORDIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentORDIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentORDIPERPInterface;
