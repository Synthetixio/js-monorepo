...
export const name = 'PerpsV2MarketStateLTCPERP';
export const address = '0xEbf0c8d6AE4Ee2538F24e514FF4705d599644Aa7';
...
export interface PerpsV2MarketStateLTCPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateLTCPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateLTCPERPInterface;
