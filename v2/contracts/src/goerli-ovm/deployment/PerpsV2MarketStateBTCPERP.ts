...
export const name = 'PerpsV2MarketStateBTCPERP';
export const address = '0xb82C1c9491A529F7AB9B4A6d42537eDDe28d83F3';
...
export interface PerpsV2MarketStateBTCPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateBTCPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateBTCPERPInterface;
