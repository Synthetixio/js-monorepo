...
export const name = 'PerpsV2MarketViewsEURPERP';
export const address = '0xB2bBCc08B930717387De4f8a713801eD6b9361b8';
...
export interface PerpsV2MarketViewsEURPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsEURPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsEURPERPInterface;
