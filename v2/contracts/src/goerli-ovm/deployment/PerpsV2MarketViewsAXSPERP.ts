...
export const name = 'PerpsV2MarketViewsAXSPERP';
export const address = '0x9EBbA62E0f553C9c78491F4113575adf8f0337f3';
...
export interface PerpsV2MarketViewsAXSPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsAXSPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsAXSPERPInterface;
