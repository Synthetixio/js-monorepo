...
export const name = 'PerpsV2OffchainDelayedOrderAXSPERP';
export const address = '0xb71a41cB1B8e0E60B850a43249e326E80fea6de5';
...
export interface PerpsV2OffchainDelayedOrderAXSPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2OffchainDelayedOrderAXSPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2OffchainDelayedOrderAXSPERPInterface;
