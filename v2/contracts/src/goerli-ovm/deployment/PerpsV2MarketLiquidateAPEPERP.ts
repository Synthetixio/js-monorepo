...
export const address = '0x3FFc4838451D04Cbf2C13189b661280c4b3C5A47';
...
export interface PerpsV2MarketLiquidateAPEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateAPEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateAPEPERPInterface;
