...
export const address = '0x860ffb8f7f7F4c61279A9E810996abe3eF6Bc4A2';
...
export interface PerpsV2DelayedIntentXLMPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentXLMPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentXLMPERPInterface;
