...
export const address = '0x565F22A5A5b06e73F3D0cf6A2fB66E285179F137';
...
export interface PerpsV2DelayedExecutionOPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionOPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionOPPERPInterface;
