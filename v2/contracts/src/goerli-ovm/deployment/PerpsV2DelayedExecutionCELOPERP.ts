...
export const address = '0xA01a3FeeD5dcC2308BebF8a5356d8Be830FbC4Ad';
...
export interface PerpsV2DelayedExecutionCELOPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionCELOPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionCELOPERPInterface;
