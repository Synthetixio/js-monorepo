...
export const name = 'FuturesMarketEUR';
export const address = '0xAd4d525C8B6eAE32c3BFE8de5c7f87791690CdB3';
...
export interface FuturesMarketEURInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketEUR extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketEURInterface;
