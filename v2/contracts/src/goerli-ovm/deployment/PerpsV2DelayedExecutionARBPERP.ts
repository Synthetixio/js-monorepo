...
export const address = '0xC98788bd48A371637Dc849B266769E87CBD8Abd9';
...
export interface PerpsV2DelayedExecutionARBPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionARBPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionARBPERPInterface;
