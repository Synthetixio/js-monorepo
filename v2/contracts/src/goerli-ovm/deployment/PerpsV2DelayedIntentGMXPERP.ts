...
export const address = '0x8F1885508D179B09Aa618b9d40eD6592946EcBE0';
...
export interface PerpsV2DelayedIntentGMXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentGMXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentGMXPERPInterface;
