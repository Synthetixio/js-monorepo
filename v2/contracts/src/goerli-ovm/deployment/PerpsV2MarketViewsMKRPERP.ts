...
export const name = 'PerpsV2MarketViewsMKRPERP';
export const address = '0x5bd2FA198f0e4822f819E53c4e5342C357013C4c';
...
export interface PerpsV2MarketViewsMKRPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsMKRPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsMKRPERPInterface;
