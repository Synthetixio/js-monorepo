...
export const name = 'PerpsV2MarketStateBCHPERP';
export const address = '0x9341E4E08f89F6db7A4Dd0a86bC4B08491cA6b5E';
...
export interface PerpsV2MarketStateBCHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateBCHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateBCHPERPInterface;
