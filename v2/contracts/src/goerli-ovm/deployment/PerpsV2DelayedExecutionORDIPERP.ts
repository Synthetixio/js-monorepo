...
export const address = '0x9b17EB6eDfDd827f681cAE823DFF6a2282C2682a';
...
export interface PerpsV2DelayedExecutionORDIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionORDIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionORDIPERPInterface;
