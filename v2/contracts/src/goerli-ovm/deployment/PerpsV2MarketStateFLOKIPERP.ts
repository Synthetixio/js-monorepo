...
export const name = 'PerpsV2MarketStateFLOKIPERP';
export const address = '0xfd4bCbA2b3FF9D3011D73069955e41419d8FE34b';
...
export interface PerpsV2MarketStateFLOKIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateFLOKIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateFLOKIPERPInterface;
