...
export const name = 'PerpsV2MarketStateXRPPERP';
export const address = '0xfC2030B9C1d8B170240770006D52E9F81Ecb4642';
...
export interface PerpsV2MarketStateXRPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateXRPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateXRPPERPInterface;
