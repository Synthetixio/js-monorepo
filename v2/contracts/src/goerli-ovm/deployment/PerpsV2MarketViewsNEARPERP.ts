...
export const name = 'PerpsV2MarketViewsNEARPERP';
export const address = '0xbd2998Ae30A6B5026967ae9aE929A865c2288739';
...
export interface PerpsV2MarketViewsNEARPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsNEARPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsNEARPERPInterface;
