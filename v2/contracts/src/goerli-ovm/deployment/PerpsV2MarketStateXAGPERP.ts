...
export const name = 'PerpsV2MarketStateXAGPERP';
export const address = '0xa394e42D93a8B9EB4F758566b79dA150CA5B7Fa0';
...
export interface PerpsV2MarketStateXAGPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateXAGPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateXAGPERPInterface;
