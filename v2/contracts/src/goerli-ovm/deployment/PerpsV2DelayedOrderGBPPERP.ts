...
export const name = 'PerpsV2DelayedOrderGBPPERP';
export const address = '0x71848580eB88408e36B590231508d5b120C57360';
...
export interface PerpsV2DelayedOrderGBPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedOrderGBPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedOrderGBPPERPInterface;
