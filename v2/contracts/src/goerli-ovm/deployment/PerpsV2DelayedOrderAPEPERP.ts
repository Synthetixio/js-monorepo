...
export const name = 'PerpsV2DelayedOrderAPEPERP';
export const address = '0x844f98835b57970f6a86Fdb884AFe114103c14C5';
...
export interface PerpsV2DelayedOrderAPEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedOrderAPEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedOrderAPEPERPInterface;
