...
export const address = '0x382beD459076B2C288e258065b40D107e0092D85';
...
export interface PerpsV2DelayedExecutionMEMEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionMEMEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionMEMEPERPInterface;
