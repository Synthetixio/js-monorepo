...
export const address = '0x07fc0993cEA1De85DE8C521cC631C511D5ea153D';
...
export interface PerpsV2DelayedIntentONEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentONEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentONEPERPInterface;
