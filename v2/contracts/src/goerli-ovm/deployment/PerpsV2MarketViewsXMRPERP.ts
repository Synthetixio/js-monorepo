...
export const name = 'PerpsV2MarketViewsXMRPERP';
export const address = '0xa4C3709247CD97dC132d7ad4a16ef908a4c9ce5D';
...
export interface PerpsV2MarketViewsXMRPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsXMRPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsXMRPERPInterface;
