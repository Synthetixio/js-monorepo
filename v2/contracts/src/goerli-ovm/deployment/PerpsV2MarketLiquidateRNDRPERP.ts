...
export const address = '0xcDbCfDc90585c439429E796dD327108Ad2715fED';
...
export interface PerpsV2MarketLiquidateRNDRPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateRNDRPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateRNDRPERPInterface;
