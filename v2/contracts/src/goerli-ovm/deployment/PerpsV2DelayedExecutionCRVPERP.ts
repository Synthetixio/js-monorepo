...
export const address = '0xAF2BA81B3725A79925FcAa132ecde40Fba41Aa09';
...
export interface PerpsV2DelayedExecutionCRVPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionCRVPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionCRVPERPInterface;
