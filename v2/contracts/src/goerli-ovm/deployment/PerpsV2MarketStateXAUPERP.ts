...
export const name = 'PerpsV2MarketStateXAUPERP';
export const address = '0xc9951483d3f8370BCb9617805Ce3B7873B5aDA08';
...
export interface PerpsV2MarketStateXAUPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateXAUPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateXAUPERPInterface;
