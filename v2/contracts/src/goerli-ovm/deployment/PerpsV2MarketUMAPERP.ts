...
export const address = '0xc26e5f30AD8B3bC626B88f87D23b1C011754d110';
...
export interface PerpsV2MarketUMAPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketUMAPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketUMAPERPInterface;
