...
export const address = '0x168fF410A82FD5D9BA3f5f0bd34862DC95329096';
...
export interface PerpsV2DelayedExecutionRPLPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionRPLPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionRPLPERPInterface;
