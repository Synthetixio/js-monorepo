...
export const address = '0x752B2f8296e4d32D2ED27C78b0e29739ff9F9b5a';
...
export interface PerpsV2MarketATOMPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketATOMPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketATOMPERPInterface;
