...
export const address = '0x246B410eB93c56cD2263585B492b5c043f6f0B5D';
...
export interface PerpsV2DelayedIntentRPLPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentRPLPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentRPLPERPInterface;
