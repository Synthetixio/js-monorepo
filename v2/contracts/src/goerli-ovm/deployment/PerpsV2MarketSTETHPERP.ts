...
export const address = '0xB2A4d1428238955De5764A6F15ad45bBF26A2646';
...
export interface PerpsV2MarketSTETHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketSTETHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketSTETHPERPInterface;
