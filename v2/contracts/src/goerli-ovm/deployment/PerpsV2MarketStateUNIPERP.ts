...
export const name = 'PerpsV2MarketStateUNIPERP';
export const address = '0x9dD3D55Be18D138E304A6191D78baf62ec12044e';
...
export interface PerpsV2MarketStateUNIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateUNIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateUNIPERPInterface;
