...
export const address = '0xc006bd42B2ca95Cd640D314dA3DF4c59436C7739';
...
export interface FuturesMarketDOGEInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketDOGE extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketDOGEInterface;
