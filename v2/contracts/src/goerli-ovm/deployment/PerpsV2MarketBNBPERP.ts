...
export const address = '0xbe8A82d7B731Ee2243F9F0B77b25f8462C57929C';
...
export interface PerpsV2MarketBNBPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketBNBPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketBNBPERPInterface;
