...
export const address = '0x99D6201a4A9367E0334455734675370A561Ae049';
...
export interface PerpsV2DelayedExecutionAPEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionAPEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionAPEPERPInterface;
