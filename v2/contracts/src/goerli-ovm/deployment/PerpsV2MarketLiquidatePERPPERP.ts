...
export const address = '0x2b6a67482896dE4A6a92221D8e5E52aD7787C31c';
...
export interface PerpsV2MarketLiquidatePERPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidatePERPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidatePERPPERPInterface;
