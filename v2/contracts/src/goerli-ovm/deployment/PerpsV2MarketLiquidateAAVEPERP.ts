...
export const address = '0xD139D7cF6A5D6D46Bd92Da0e81B1509abEE2fB96';
...
export interface PerpsV2MarketLiquidateAAVEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateAAVEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateAAVEPERPInterface;
