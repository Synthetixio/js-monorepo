...
export const address = '0x6D5EC0aC8A53C7d72356D654DEf244B9874589f7';
...
export interface PerpsV2DelayedIntentAVAXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentAVAXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentAVAXPERPInterface;
