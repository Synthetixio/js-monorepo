...
export const name = 'PerpsV2DelayedOrderDYDXPERP';
export const address = '0x8bDe1A85CC3B889fFF13e3083312975266051959';
...
export interface PerpsV2DelayedOrderDYDXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedOrderDYDXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedOrderDYDXPERPInterface;
