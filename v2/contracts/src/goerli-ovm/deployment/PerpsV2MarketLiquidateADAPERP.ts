...
export const address = '0x227f3f08a82d3aA818271eB400D847132a5f2332';
...
export interface PerpsV2MarketLiquidateADAPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateADAPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateADAPERPInterface;
