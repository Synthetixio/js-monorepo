...
export const address = '0xbF8038402BC585F65F048950cFD4Dde38584c441';
...
export interface PerpsV2MarketGBPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketGBPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketGBPPERPInterface;
