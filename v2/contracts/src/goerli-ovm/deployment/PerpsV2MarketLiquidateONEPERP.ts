...
export const address = '0x8F67aeE05D85348d7f4A11D1FFefE584950edc34';
...
export interface PerpsV2MarketLiquidateONEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateONEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateONEPERPInterface;
