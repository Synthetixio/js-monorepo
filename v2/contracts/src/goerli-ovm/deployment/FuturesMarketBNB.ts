...
export const address = '0x3F66f483b8A66EcBbF3385E5Df6C581c2378d8B7';
...
export interface FuturesMarketBNBInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketBNB extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketBNBInterface;
