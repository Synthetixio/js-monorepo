...
export const name = 'PerpsV2MarketViewsBCHPERP';
export const address = '0x31DbBa66F9f9CC633074849e7BE355862bc39842';
...
export interface PerpsV2MarketViewsBCHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsBCHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsBCHPERPInterface;
