...
export const address = '0xa2D90f2bA200CE90D5492Ff862A8406142eBC5Ed';
...
export interface PerpsV2DelayedExecutionKNCPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionKNCPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionKNCPERPInterface;
