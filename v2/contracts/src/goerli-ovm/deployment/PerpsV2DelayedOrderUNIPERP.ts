...
export const name = 'PerpsV2DelayedOrderUNIPERP';
export const address = '0x774506226e943d7ca12A271836a2Af5F97b543b4';
...
export interface PerpsV2DelayedOrderUNIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedOrderUNIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedOrderUNIPERPInterface;
