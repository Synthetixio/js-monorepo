...
export const address = '0x653312A4de349a3E8F752794285857665A961373';
...
export interface PerpsV2ProxyONEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyONEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyONEPERPInterface;
