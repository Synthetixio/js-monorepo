...
export const address = '0xE51A5F0639CA2CE820ef0584e0c81073532e2460';
...
export interface PerpsV2MarketLiquidateSTETHETHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateSTETHETHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateSTETHETHPERPInterface;
