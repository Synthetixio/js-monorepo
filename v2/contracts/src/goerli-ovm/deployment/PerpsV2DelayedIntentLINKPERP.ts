...
export const address = '0x4CdDA2b812Fc4dd5aB00fA8B118604ba275f34eB';
...
export interface PerpsV2DelayedIntentLINKPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentLINKPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentLINKPERPInterface;
