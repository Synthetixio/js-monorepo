...
export const name = 'PerpsV2MarketViewsBNBPERP';
export const address = '0x09f9F716aE8d26Db126e120F9Bbfd06615428058';
...
export interface PerpsV2MarketViewsBNBPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsBNBPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsBNBPERPInterface;
