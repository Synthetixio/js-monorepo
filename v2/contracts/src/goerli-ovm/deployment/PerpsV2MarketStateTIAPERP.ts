...
export const name = 'PerpsV2MarketStateTIAPERP';
export const address = '0xBF690B8c82e9C316f56285A509F54eE7127A2e8e';
...
export interface PerpsV2MarketStateTIAPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateTIAPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateTIAPERPInterface;
