...
export const name = 'PerpsV2DelayedOrderEURPERP';
export const address = '0x39d1Fad09590BcBaeF683E349176DcFd4E428Ed6';
...
export interface PerpsV2DelayedOrderEURPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedOrderEURPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedOrderEURPERPInterface;
