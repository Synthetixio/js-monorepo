...
export const name = 'PerpsV2MarketStateAVAXPERP';
export const address = '0x7d470b2c680Df1299e181E6a2Ec00A97fA5b3a2c';
...
export interface PerpsV2MarketStateAVAXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateAVAXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateAVAXPERPInterface;
