...
export const address = '0xD71cdC5cb38AC6D0Ec86043AE3BDc5615981e508';
...
export interface PerpsV2DelayedIntentUMAPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentUMAPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentUMAPERPInterface;
