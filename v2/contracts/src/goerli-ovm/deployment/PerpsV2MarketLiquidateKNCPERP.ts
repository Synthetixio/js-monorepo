...
export const address = '0x8Fe9587Af4126e04446d11Ff8B024600D6f09691';
...
export interface PerpsV2MarketLiquidateKNCPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateKNCPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateKNCPERPInterface;
