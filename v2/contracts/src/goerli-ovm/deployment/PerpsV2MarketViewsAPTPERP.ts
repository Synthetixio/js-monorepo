...
export const name = 'PerpsV2MarketViewsAPTPERP';
export const address = '0x0AECf40653aAC5fF1da1916a2eBE3fc439014c90';
...
export interface PerpsV2MarketViewsAPTPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsAPTPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsAPTPERPInterface;
