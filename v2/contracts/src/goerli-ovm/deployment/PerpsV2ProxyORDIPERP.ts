...
export const address = '0xE493b28d8F9DcdDD5e8187CB87cB04cdF23e32E9';
...
export interface PerpsV2ProxyORDIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyORDIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyORDIPERPInterface;
