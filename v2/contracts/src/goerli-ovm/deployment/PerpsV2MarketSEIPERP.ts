...
export const address = '0xea4d80c60238F283787998C2b242Eb250D32190b';
...
export interface PerpsV2MarketSEIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketSEIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketSEIPERPInterface;
