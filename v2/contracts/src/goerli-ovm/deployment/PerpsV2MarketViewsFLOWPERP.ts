...
export const name = 'PerpsV2MarketViewsFLOWPERP';
export const address = '0x35E3BdA371055942A8F6EF119756b3F0271b4b97';
...
export interface PerpsV2MarketViewsFLOWPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsFLOWPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsFLOWPERPInterface;
