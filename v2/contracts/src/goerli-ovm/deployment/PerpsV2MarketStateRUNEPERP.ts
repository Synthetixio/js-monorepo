...
export const name = 'PerpsV2MarketStateRUNEPERP';
export const address = '0x3C141aC3EAa12f8082298338fCD9D854874C3c31';
...
export interface PerpsV2MarketStateRUNEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateRUNEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateRUNEPERPInterface;
