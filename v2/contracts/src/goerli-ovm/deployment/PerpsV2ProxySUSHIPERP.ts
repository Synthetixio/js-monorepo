...
export const address = '0x64b9F72F7D5a78B597A108aaE5fE2dCB17a6B1F3';
...
export interface PerpsV2ProxySUSHIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxySUSHIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxySUSHIPERPInterface;
