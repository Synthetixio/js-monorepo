...
export const name = 'FuturesMarketUNI';
export const address = '0x44Af736495544a726ED15CB0EBe2d87a6bCC1832';
...
export interface FuturesMarketUNIInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketUNI extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketUNIInterface;
