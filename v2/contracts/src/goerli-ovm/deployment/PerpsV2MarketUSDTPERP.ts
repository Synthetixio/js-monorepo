...
export const address = '0x5C3e7A416F3004212f93A05f4CB4c7c7Ad682CFC';
...
export interface PerpsV2MarketUSDTPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketUSDTPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketUSDTPERPInterface;
