...
export const name = 'PerpsV2MarketViewsMATICPERP';
export const address = '0x111c50A90d493cd1D04F58d43Ce472A8edE2A2B5';
...
export interface PerpsV2MarketViewsMATICPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsMATICPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsMATICPERPInterface;
