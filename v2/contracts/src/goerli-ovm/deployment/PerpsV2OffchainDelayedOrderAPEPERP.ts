...
export const name = 'PerpsV2OffchainDelayedOrderAPEPERP';
export const address = '0xf6f173C31B3a24Fbe23cC7f30D5F98fe929172DE';
...
export interface PerpsV2OffchainDelayedOrderAPEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2OffchainDelayedOrderAPEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2OffchainDelayedOrderAPEPERPInterface;
