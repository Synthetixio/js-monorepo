...
export const name = 'PerpsV2DelayedOrderXAGPERP';
export const address = '0x655599aa4AB094Fc43e9708d81d3D0cb8677ea4e';
...
export interface PerpsV2DelayedOrderXAGPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedOrderXAGPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedOrderXAGPERPInterface;
