...
export const address = '0x1E4C2ea8D037D2638b1e5945392261FE4959F433';
...
export interface PerpsV2DelayedIntentRNDRPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentRNDRPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentRNDRPERPInterface;
