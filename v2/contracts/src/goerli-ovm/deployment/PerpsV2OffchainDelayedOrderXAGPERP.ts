...
export const name = 'PerpsV2OffchainDelayedOrderXAGPERP';
export const address = '0xBE14F44dc2DE3A905019f06e5279c60e45102659';
...
export interface PerpsV2OffchainDelayedOrderXAGPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2OffchainDelayedOrderXAGPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2OffchainDelayedOrderXAGPERPInterface;
