...
export const name = 'PerpsV2MarketViewsPERPPERP';
export const address = '0x968024f6856f2a32A1424897A7f5BCFBa79c76ba';
...
export interface PerpsV2MarketViewsPERPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsPERPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsPERPPERPInterface;
