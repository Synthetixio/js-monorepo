...
export const name = 'PerpsV2MarketStateNEARPERP';
export const address = '0xEFEd528e5161fE26632fa1195A4a6d692cCb66D7';
...
export interface PerpsV2MarketStateNEARPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateNEARPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateNEARPERPInterface;
