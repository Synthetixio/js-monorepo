...
export const address = '0x4D70F91572431Ef3D674F1d4Cd33C3B5F4Eb4b36';
...
export interface PerpsV2MarketCOMPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketCOMPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketCOMPPERPInterface;
