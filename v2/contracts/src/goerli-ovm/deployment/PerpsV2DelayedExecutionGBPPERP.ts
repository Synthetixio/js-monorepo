...
export const address = '0x48d01790eA130d0Fc162ca163395e83E06ab4790';
...
export interface PerpsV2DelayedExecutionGBPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionGBPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionGBPPERPInterface;
