...
export const name = 'PerpsV2MarketStateGRTPERP';
export const address = '0xf30B37872aeC0A4059Ac93eF5015C37b7b52405E';
...
export interface PerpsV2MarketStateGRTPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateGRTPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateGRTPERPInterface;
