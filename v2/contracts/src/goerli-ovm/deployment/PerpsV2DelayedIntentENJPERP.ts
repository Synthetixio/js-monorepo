...
export const address = '0x54bacDF5a4A6CD229ff4a30c497f99c14aCD7093';
...
export interface PerpsV2DelayedIntentENJPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentENJPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentENJPERPInterface;
