...
export const address = '0x2e4272cBC45B058ACdd8312a5704E67F36fBBE69';
...
export interface PerpsV2DelayedExecutionMKRPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionMKRPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionMKRPERPInterface;
