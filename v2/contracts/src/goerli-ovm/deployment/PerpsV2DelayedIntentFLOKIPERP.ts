...
export const address = '0x7AbD8a89B841BBE668F4826Dbd4EE7520406794c';
...
export interface PerpsV2DelayedIntentFLOKIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentFLOKIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentFLOKIPERPInterface;
