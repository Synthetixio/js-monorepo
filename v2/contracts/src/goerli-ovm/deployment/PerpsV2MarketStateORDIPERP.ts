...
export const name = 'PerpsV2MarketStateORDIPERP';
export const address = '0x6A5d6D7D740DABFC5Eb632e7C14f88fac7900a78';
...
export interface PerpsV2MarketStateORDIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateORDIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateORDIPERPInterface;
