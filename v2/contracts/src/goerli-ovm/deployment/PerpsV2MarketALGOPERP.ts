...
export const address = '0x7373577fbAC46C99581663312fFBBBa27D068f3d';
...
export interface PerpsV2MarketALGOPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketALGOPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketALGOPERPInterface;
