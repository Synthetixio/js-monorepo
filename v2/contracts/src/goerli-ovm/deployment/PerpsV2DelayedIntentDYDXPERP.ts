...
export const address = '0x14d4538996C3512cE0766Af03fA9Ec54844013cC';
...
export interface PerpsV2DelayedIntentDYDXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentDYDXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentDYDXPERPInterface;
