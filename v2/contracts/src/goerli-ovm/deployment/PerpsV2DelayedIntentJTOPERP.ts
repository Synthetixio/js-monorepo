...
export const address = '0xA764E85b8D3A5ff85e3c01ffCC6CaC199Af2689A';
...
export interface PerpsV2DelayedIntentJTOPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentJTOPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentJTOPERPInterface;
