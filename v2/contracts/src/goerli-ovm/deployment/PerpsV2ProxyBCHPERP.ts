...
export const address = '0x7de607f45ea85512689566D786e513aF384D6CBb';
...
export interface PerpsV2ProxyBCHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyBCHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyBCHPERPInterface;
