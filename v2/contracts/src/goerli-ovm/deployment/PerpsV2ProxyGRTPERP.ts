...
export const address = '0xa728fB90fc0F8DE45F4fD26330fe209893555702';
...
export interface PerpsV2ProxyGRTPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyGRTPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyGRTPERPInterface;
