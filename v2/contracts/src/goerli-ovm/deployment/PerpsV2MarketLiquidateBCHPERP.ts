...
export const address = '0x9D9F6911d590427f114183c5eB43fF61889Cf7F5';
...
export interface PerpsV2MarketLiquidateBCHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateBCHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateBCHPERPInterface;
