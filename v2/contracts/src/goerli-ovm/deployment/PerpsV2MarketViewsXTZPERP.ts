...
export const name = 'PerpsV2MarketViewsXTZPERP';
export const address = '0x723024639F2f0226e4308aB732b8E7e2FbAaBfF1';
...
export interface PerpsV2MarketViewsXTZPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsXTZPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsXTZPERPInterface;
