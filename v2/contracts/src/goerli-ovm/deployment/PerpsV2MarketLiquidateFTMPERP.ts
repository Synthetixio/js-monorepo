...
export const address = '0xD9419e42ea0541f55B1774ff196Ea9ECb9D43eA1';
...
export interface PerpsV2MarketLiquidateFTMPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateFTMPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateFTMPERPInterface;
