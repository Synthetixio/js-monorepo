...
export const address = '0x0E7C0B288C14E29eb3125C0812687E1d4F14F6bC';
...
export interface PerpsV2ProxyPEPEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyPEPEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyPEPEPERPInterface;
