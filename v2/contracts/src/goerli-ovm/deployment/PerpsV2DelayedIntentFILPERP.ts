...
export const address = '0x347E852dD8CfAFC1Ee843D7bbDD6a22E0f4EBF24';
...
export interface PerpsV2DelayedIntentFILPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentFILPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentFILPERPInterface;
