...
export const address = '0xb97e868a340BA00C10557c234C9F17cC41B0f667';
...
export interface PerpsV2ProxyDYDXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyDYDXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyDYDXPERPInterface;
