...
export const name = 'PerpsV2MarketViewsFTMPERP';
export const address = '0x0cE058D5FBa7203B1A90813E8ae1d4d1573972a5';
...
export interface PerpsV2MarketViewsFTMPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsFTMPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsFTMPERPInterface;
