...
export const name = 'PerpsV2MarketViewsLINKPERP';
export const address = '0xB65Ef66CD9Ad5BF2A26530242f638F9d47b8726b';
...
export interface PerpsV2MarketViewsLINKPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsLINKPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsLINKPERPInterface;
