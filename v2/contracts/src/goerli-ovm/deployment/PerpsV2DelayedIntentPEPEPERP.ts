...
export const address = '0xAa8C8E1c8179172cbE69c748009EF437714a3d0B';
...
export interface PerpsV2DelayedIntentPEPEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentPEPEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentPEPEPERPInterface;
