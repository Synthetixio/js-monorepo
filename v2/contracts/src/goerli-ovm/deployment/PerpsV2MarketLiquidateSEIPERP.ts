...
export const address = '0xAa88a2A9344c8D403782059DFF736eA883705063';
...
export interface PerpsV2MarketLiquidateSEIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateSEIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateSEIPERPInterface;
