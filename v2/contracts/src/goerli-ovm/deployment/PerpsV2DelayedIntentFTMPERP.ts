...
export const address = '0x1377066b856f16AC7141a8eC3a7D7Ad9305277bD';
...
export interface PerpsV2DelayedIntentFTMPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentFTMPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentFTMPERPInterface;
