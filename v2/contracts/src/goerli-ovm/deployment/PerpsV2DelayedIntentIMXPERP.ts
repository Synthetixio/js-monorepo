...
export const address = '0xbc3F1C7310AFed984dA12511b39a6d4D6335b696';
...
export interface PerpsV2DelayedIntentIMXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentIMXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentIMXPERPInterface;
