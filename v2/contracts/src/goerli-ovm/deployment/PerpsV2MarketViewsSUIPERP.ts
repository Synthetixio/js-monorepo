...
export const name = 'PerpsV2MarketViewsSUIPERP';
export const address = '0x50E751c803b49c1B3628cfA07CCB789Fd6C4661C';
...
export interface PerpsV2MarketViewsSUIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsSUIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsSUIPERPInterface;
