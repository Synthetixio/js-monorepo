...
export const name = 'PerpsV2MarketViewsXAGPERP';
export const address = '0x205Cf8876d0D22C5FcD684F6f39F6b43D3D5A217';
...
export interface PerpsV2MarketViewsXAGPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsXAGPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsXAGPERPInterface;
