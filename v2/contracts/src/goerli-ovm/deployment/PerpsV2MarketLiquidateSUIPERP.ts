...
export const address = '0x15aBc49162b4BC832b668301CC998a4E81dC7d2b';
...
export interface PerpsV2MarketLiquidateSUIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateSUIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateSUIPERPInterface;
