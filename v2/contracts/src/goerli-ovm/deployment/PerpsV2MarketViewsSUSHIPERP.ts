...
export const name = 'PerpsV2MarketViewsSUSHIPERP';
export const address = '0xec9Ae77028F15279D12CAC9C59085E8608da4091';
...
export interface PerpsV2MarketViewsSUSHIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsSUSHIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsSUSHIPERPInterface;
