...
export const name = 'PerpsV2MarketViewsOPPERP';
export const address = '0x7C7518149D56ad9fcfF2BD1406e74fadf278603C';
...
export interface PerpsV2MarketViewsOPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsOPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsOPPERPInterface;
