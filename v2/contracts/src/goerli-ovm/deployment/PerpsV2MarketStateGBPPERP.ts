...
export const name = 'PerpsV2MarketStateGBPPERP';
export const address = '0xD4B5e6fD9D5E2C192CF0DA5B56702A5F12459Bc8';
...
export interface PerpsV2MarketStateGBPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateGBPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateGBPPERPInterface;
