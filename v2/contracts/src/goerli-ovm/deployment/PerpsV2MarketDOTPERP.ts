...
export const address = '0x3b6b53C201862a3FE1C82A6F81269da8B9fE18c4';
...
export interface PerpsV2MarketDOTPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketDOTPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketDOTPERPInterface;
