...
export const name = 'PerpsV2MarketStateENJPERP';
export const address = '0x01e57792CC8e32be4164dc3A14D9F5176CE97cB7';
...
export interface PerpsV2MarketStateENJPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateENJPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateENJPERPInterface;
