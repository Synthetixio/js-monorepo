...
export const address = '0x242E2C8DbCc24bebAc1C8322b8371DAa0c89e1bB';
...
export interface PerpsV2MarketAXSPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketAXSPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketAXSPERPInterface;
