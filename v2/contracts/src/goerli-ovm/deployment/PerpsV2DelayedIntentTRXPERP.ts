...
export const address = '0xABCce7384973cA33Dbfa34B9b691786A512eA5Fb';
...
export interface PerpsV2DelayedIntentTRXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentTRXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentTRXPERPInterface;
