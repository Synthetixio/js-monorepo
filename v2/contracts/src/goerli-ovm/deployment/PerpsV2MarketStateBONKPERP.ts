...
export const name = 'PerpsV2MarketStateBONKPERP';
export const address = '0x0FfDe0fE0395ADeBCD85763EA5730aD273754e2E';
...
export interface PerpsV2MarketStateBONKPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateBONKPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateBONKPERPInterface;
