...
export const address = '0xD7b63D474d0edb92b9576538Bf0D52e538b3e282';
...
export interface PerpsV2DelayedIntentCOMPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentCOMPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentCOMPPERPInterface;
