...
export const address = '0x7F5627eeb1f1ae1641FEf8e853b914B5569f8B5c';
...
export interface PerpsV2MarketLDOPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLDOPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLDOPERPInterface;
