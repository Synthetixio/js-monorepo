...
export const name = 'PerpsV2MarketStateBLURPERP';
export const address = '0xb0d5718E6b977bb5Cd05fc5cdd761b0a7254c96b';
...
export interface PerpsV2MarketStateBLURPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateBLURPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateBLURPERPInterface;
