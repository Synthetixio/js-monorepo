...
export interface PerpsV2ProxyGBPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyGBPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyGBPPERPInterface;
