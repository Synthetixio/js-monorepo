...
export const name = 'PerpsV2DelayedOrderARBPERP';
export const address = '0x0f5af2A8a4Df79e354455788fdA73bed85AB435C';
...
export interface PerpsV2DelayedOrderARBPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedOrderARBPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedOrderARBPERPInterface;
