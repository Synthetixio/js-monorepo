...
export const name = 'PerpsV2MarketViewsONEPERP';
export const address = '0xA4d53f6CBCF314f318f316ae61cDd400c974085d';
...
export interface PerpsV2MarketViewsONEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsONEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsONEPERPInterface;
