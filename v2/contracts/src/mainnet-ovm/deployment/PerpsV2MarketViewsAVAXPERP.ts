...
export const name = 'PerpsV2MarketViewsAVAXPERP';
export const address = '0x69d255473d0d15DC087cbf4962a65839aa28A2C5';
...
export interface PerpsV2MarketViewsAVAXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsAVAXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsAVAXPERPInterface;
