...
export const name = 'PerpsV2DelayedOrderBNBPERP';
export const address = '0xaf476d7817105437aed79a86E802b79D4B1c473F';
...
export interface PerpsV2DelayedOrderBNBPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedOrderBNBPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedOrderBNBPERPInterface;
