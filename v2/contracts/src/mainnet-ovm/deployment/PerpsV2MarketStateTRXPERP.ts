...
export const name = 'PerpsV2MarketStateTRXPERP';
export const address = '0x52cCa59bFa0228F41Ab69558F5f2EE3739323c02';
...
export interface PerpsV2MarketStateTRXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateTRXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateTRXPERPInterface;
