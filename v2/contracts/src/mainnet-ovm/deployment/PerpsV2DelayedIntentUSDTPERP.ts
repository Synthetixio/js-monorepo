...
export interface PerpsV2DelayedIntentUSDTPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentUSDTPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentUSDTPERPInterface;
