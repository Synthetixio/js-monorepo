...
export interface PerpsV2MarketTRXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketTRXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketTRXPERPInterface;
