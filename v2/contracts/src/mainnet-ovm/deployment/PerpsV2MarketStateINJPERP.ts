...
export const name = 'PerpsV2MarketStateINJPERP';
export const address = '0x4C35c27fF8F0dD039B4C4F0D670f2D58f6215c9C';
...
export interface PerpsV2MarketStateINJPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateINJPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateINJPERPInterface;
