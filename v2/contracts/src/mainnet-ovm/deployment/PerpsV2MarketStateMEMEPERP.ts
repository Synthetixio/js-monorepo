...
export const name = 'PerpsV2MarketStateMEMEPERP';
export const address = '0xeF35211B545B8f7EAF77F0d144A2e023d21Cb453';
...
export interface PerpsV2MarketStateMEMEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateMEMEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateMEMEPERPInterface;
