...
export const name = 'PerpsV2MarketStateLINKPERP';
export const address = '0x49dC714eaD0cc585eBaC8A412098914a2CE7B7B2';
...
export interface PerpsV2MarketStateLINKPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateLINKPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateLINKPERPInterface;
