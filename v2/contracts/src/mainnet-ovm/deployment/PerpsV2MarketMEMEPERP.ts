...
export interface PerpsV2MarketMEMEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketMEMEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketMEMEPERPInterface;
