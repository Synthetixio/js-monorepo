...
export const name = 'PerpsV2MarketStateDOTPERP';
export const address = '0xCF33a35F0f2095ABdD0C81dbde3A1cD37bE0c5cC';
...
export interface PerpsV2MarketStateDOTPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateDOTPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateDOTPERPInterface;
