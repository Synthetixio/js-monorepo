...
export const name = 'PerpsV2MarketStateXMRPERP';
export const address = '0x3d869950817920Eda9fC9A633ab7F06B97444dd7';
...
export interface PerpsV2MarketStateXMRPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateXMRPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateXMRPERPInterface;
