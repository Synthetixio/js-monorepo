...
export const name = 'PerpsV2MarketStateFILPERP';
export const address = '0x71FD2f49f289d75D0C1E108c97Fcb2a4c54Ab424';
...
export interface PerpsV2MarketStateFILPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateFILPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateFILPERPInterface;
