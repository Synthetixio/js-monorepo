...
export const name = 'PerpsV2MarketStateARBPERP';
export const address = '0xa31717145C27bb37868829E92A3601014768d145';
...
export interface PerpsV2MarketStateARBPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateARBPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateARBPERPInterface;
