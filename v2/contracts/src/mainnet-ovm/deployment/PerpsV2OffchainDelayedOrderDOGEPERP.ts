...
export const name = 'PerpsV2OffchainDelayedOrderDOGEPERP';
export const address = '0xfde9d8F4d2fB18823363fdd0E1fF305c4696A19D';
...
export interface PerpsV2OffchainDelayedOrderDOGEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2OffchainDelayedOrderDOGEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2OffchainDelayedOrderDOGEPERPInterface;
