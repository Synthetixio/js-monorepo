...
export const name = 'PerpsV2MarketStateXTZPERP';
export const address = '0xaf621161755C601C1469e3487ce971f39Ae507BC';
...
export interface PerpsV2MarketStateXTZPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateXTZPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateXTZPERPInterface;
