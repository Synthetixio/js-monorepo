...
export interface PerpsV2ProxyXRPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyXRPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyXRPPERPInterface;
