...
export interface PerpsV2ProxyFTMPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyFTMPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyFTMPERPInterface;
