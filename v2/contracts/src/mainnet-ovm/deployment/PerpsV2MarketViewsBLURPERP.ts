...
export const name = 'PerpsV2MarketViewsBLURPERP';
export const address = '0xeD20040b21FDf6d68336F6E61AD05F235e3eA9f3';
...
export interface PerpsV2MarketViewsBLURPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsBLURPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsBLURPERPInterface;
