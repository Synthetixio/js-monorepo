...
export const name = 'PerpsV2OffchainDelayedOrderDYDXPERP';
export const address = '0xF612F3098a277cb80Ad03f20cf7787aD1Dc48f4a';
...
export interface PerpsV2OffchainDelayedOrderDYDXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2OffchainDelayedOrderDYDXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2OffchainDelayedOrderDYDXPERPInterface;
