...
export const name = 'PerpsV2MarketViewsXRPPERP';
export const address = '0x047B3714f3B3adFC1aa1F31c710ca3cA967Aeaa3';
...
export interface PerpsV2MarketViewsXRPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsXRPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsXRPPERPInterface;
