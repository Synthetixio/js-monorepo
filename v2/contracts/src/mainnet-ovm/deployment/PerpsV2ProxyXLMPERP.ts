...
export interface PerpsV2ProxyXLMPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyXLMPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyXLMPERPInterface;
