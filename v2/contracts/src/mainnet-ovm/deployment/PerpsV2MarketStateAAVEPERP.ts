...
export const name = 'PerpsV2MarketStateAAVEPERP';
export const address = '0x9821CC43096b3F35744423C9B029854064dfe9Ab';
...
export interface PerpsV2MarketStateAAVEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateAAVEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateAAVEPERPInterface;
