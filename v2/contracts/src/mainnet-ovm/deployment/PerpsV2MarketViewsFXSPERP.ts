...
export const name = 'PerpsV2MarketViewsFXSPERP';
export const address = '0x6a15EE080c2FdE246b674918bff3B52d414525cb';
...
export interface PerpsV2MarketViewsFXSPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsFXSPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsFXSPERPInterface;
