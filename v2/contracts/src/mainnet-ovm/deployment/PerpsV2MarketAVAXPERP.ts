...
export const address = '0x3E4EA2A0679Dec8C9040d6538B45425c72bE80D0';
...
export interface PerpsV2MarketAVAXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketAVAXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketAVAXPERPInterface;
