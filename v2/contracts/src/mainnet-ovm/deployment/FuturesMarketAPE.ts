...
export const name = 'FuturesMarketAPE';
export const address = '0xFe00395ec846240dc693e92AB2Dd720F94765Aa3';
...
export interface FuturesMarketAPEInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketAPE extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketAPEInterface;
