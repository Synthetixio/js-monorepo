...
export interface PerpsV2ProxyCOMPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyCOMPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyCOMPPERPInterface;
