...
export const name = 'PerpsV2MarketStateXLMPERP';
export const address = '0xEaFa65b829b37277a14fE43de9fAda0d9e897E4d';
...
export interface PerpsV2MarketStateXLMPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateXLMPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateXLMPERPInterface;
