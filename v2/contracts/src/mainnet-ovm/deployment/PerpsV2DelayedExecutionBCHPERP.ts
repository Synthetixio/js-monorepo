...
export interface PerpsV2DelayedExecutionBCHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionBCHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionBCHPERPInterface;
