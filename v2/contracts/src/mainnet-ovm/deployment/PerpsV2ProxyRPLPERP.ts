...
export interface PerpsV2ProxyRPLPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyRPLPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyRPLPERPInterface;
