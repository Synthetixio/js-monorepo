...
export interface PerpsV2MarketGMXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketGMXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketGMXPERPInterface;
