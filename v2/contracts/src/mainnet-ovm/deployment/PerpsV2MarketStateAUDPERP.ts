...
export const name = 'PerpsV2MarketStateAUDPERP';
export const address = '0x973dE36Bb8022942e2658D5d129CbDdCF105a470';
...
export interface PerpsV2MarketStateAUDPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateAUDPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateAUDPERPInterface;
