...
export const address = '0xdD28261FC65c4Ed29b9D11aac0F44079cfCA4F32';
...
export interface PerpsV2MarketLiquidateOPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateOPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateOPPERPInterface;
