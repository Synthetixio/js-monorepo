...
export const name = 'PerpsV2OffchainDelayedOrderMATICPERP';
export const address = '0x1651e832dcc1B9cF697810d822aee35A9f5fFD64';
...
export interface PerpsV2OffchainDelayedOrderMATICPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2OffchainDelayedOrderMATICPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2OffchainDelayedOrderMATICPERPInterface;
