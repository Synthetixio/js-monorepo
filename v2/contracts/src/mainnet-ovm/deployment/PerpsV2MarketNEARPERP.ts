...
export const address = '0xB9AbecE4Fcd56E2e3EE63fC9f60dC8A825379193';
...
export interface PerpsV2MarketNEARPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketNEARPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketNEARPERPInterface;
