...
export const name = 'PerpsV2DelayedOrderAXSPERP';
export const address = '0xfce521766201013974Dbf3B71E68b0CF8FBcd05B';
...
export interface PerpsV2DelayedOrderAXSPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedOrderAXSPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedOrderAXSPERPInterface;
