...
export interface PerpsV2ProxySUIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxySUIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxySUIPERPInterface;
