...
export const name = 'PerpsV2MarketViewsXAUPERP';
export const address = '0x9A3Ecffd8Cb317685EF0Df7B4aF5C4c9d1aF53eC';
...
export interface PerpsV2MarketViewsXAUPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsXAUPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsXAUPERPInterface;
