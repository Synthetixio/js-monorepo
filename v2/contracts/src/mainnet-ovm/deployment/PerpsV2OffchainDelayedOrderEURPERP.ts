...
export const name = 'PerpsV2OffchainDelayedOrderEURPERP';
export const address = '0xB0A058c7781F6EcA709d4b469FCc522a6fA38E60';
...
export interface PerpsV2OffchainDelayedOrderEURPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2OffchainDelayedOrderEURPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2OffchainDelayedOrderEURPERPInterface;
