...
export const name = 'PerpsV2MarketStateZRXPERP';
export const address = '0x0e4695edb83FB23E6b12AFa3660beF09610791de';
...
export interface PerpsV2MarketStateZRXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateZRXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateZRXPERPInterface;
