...
export const name = 'PerpsV2MarketViewsIMXPERP';
export const address = '0xF647dA1E37ab60A418cbd68f864b96eCAa545118';
...
export interface PerpsV2MarketViewsIMXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsIMXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsIMXPERPInterface;
