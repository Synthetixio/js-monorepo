...
export const name = 'PerpsV2MarketStateRPLPERP';
export const address = '0xf606E99D6F6a003623eA5764dA119BAEcB2e8C99';
...
export interface PerpsV2MarketStateRPLPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateRPLPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateRPLPERPInterface;
