...
export interface PerpsV2ProxyEURPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyEURPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyEURPERPInterface;
