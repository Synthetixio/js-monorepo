...
export const name = 'PerpsV2MarketViewsMAVPERP';
export const address = '0x04915C122ebA1cd7629a2a00D9aE2a4C145aB21b';
...
export interface PerpsV2MarketViewsMAVPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsMAVPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsMAVPERPInterface;
