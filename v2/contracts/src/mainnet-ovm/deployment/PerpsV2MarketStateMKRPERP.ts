...
export const name = 'PerpsV2MarketStateMKRPERP';
export const address = '0xf963a0fc0BFc38FEfE08C6062f2AD9A11AfFDEeb';
...
export interface PerpsV2MarketStateMKRPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateMKRPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateMKRPERPInterface;
