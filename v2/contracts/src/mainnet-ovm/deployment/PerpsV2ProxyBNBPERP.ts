...
export interface PerpsV2ProxyBNBPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyBNBPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyBNBPERPInterface;
