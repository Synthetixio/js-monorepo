...
export const address = '0x77769c01168011f26a39B71C9c7bA0607752E9ff';
...
export interface PerpsV2MarketLiquidateGBPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateGBPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateGBPPERPInterface;
