...
export interface PerpsV2DelayedIntentSEIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentSEIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentSEIPERPInterface;
