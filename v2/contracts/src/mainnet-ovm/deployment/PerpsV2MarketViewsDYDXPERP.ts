...
export const name = 'PerpsV2MarketViewsDYDXPERP';
export const address = '0x2e26D4beC1464409c154f653A238cE5BAAA00198';
...
export interface PerpsV2MarketViewsDYDXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsDYDXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsDYDXPERPInterface;
