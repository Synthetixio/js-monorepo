...
export const address = '0xEe8804d8Ad10b0C3aD1Bd57AC3737242aD24bB95';
...
export interface FuturesMarketBTCInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketBTC extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketBTCInterface;
