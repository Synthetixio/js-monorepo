...
export const name = 'PerpsV2MarketStateAXSPERP';
export const address = '0x78fC32b982F5f35325996655a8Bd92715CfEfD06';
...
export interface PerpsV2MarketStateAXSPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateAXSPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateAXSPERPInterface;
