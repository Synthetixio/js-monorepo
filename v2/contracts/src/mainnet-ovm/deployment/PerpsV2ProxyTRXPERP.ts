...
export interface PerpsV2ProxyTRXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyTRXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyTRXPERPInterface;
