...
export const name = 'PerpsV2OffchainDelayedOrderOPPERP';
export const address = '0xd2471115Be883EA7A32907D78062C323a5E85593';
...
export interface PerpsV2OffchainDelayedOrderOPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2OffchainDelayedOrderOPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2OffchainDelayedOrderOPPERPInterface;
