...
export const name = 'FuturesMarketMATIC';
export const address = '0xbCB2D435045E16B059b2130b28BE70b5cA47bFE5';
...
export interface FuturesMarketMATICInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketMATIC extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketMATICInterface;
