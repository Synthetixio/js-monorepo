...
export const name = 'PerpsV2DelayedOrderNEARPERP';
export const address = '0xF6CB6699367F8f61A8bF504CBe914C639D051E19';
...
export interface PerpsV2DelayedOrderNEARPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedOrderNEARPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedOrderNEARPERPInterface;
