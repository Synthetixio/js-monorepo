...
export interface PerpsV2ProxyARBPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyARBPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyARBPERPInterface;
