...
export const name = 'PerpsV2MarketViewsSHIBPERP';
export const address = '0xe4D25C54759ecd13c10e6c64aB9127c6408F9CfF';
...
export interface PerpsV2MarketViewsSHIBPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsSHIBPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsSHIBPERPInterface;
