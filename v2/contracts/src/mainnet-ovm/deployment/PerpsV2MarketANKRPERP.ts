...
export interface PerpsV2MarketANKRPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketANKRPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketANKRPERPInterface;
