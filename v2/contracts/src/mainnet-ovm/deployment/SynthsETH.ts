...
export interface SynthsETHInterface extends utils.Interface {
  functions: {
...
export interface SynthsETH extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsETHInterface;
