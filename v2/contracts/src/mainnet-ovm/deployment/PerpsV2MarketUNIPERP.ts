...
export interface PerpsV2MarketUNIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketUNIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketUNIPERPInterface;
