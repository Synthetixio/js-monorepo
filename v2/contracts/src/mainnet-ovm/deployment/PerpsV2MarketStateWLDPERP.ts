...
export const name = 'PerpsV2MarketStateWLDPERP';
export const address = '0xd4b10C896D82B3158A9a9fcb8F6fBC5A8D833C04';
...
export interface PerpsV2MarketStateWLDPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateWLDPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateWLDPERPInterface;
