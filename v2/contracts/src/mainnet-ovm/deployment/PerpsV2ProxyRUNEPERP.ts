...
export interface PerpsV2ProxyRUNEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyRUNEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyRUNEPERPInterface;
