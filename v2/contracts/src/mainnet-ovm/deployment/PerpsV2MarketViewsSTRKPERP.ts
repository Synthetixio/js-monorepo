...
export const name = 'PerpsV2MarketViewsSTRKPERP';
export const address = '0xE50DBa755fd9e9Aad8198193FF9C7e4aE1F3443a';
...
export interface PerpsV2MarketViewsSTRKPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsSTRKPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsSTRKPERPInterface;
