...
export const name = 'PerpsV2MarketViewsETCPERP';
export const address = '0x4e8f55f1948D3E61A1FD3Cd38Ce05EFC77bffEb5';
...
export interface PerpsV2MarketViewsETCPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsETCPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsETCPERPInterface;
