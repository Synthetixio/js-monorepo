...
export const address = '0x40542FEa068ED07247645581C04EfA1f83Ff04E5';
...
export interface PerpsV2MarketLiquidateNEARPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateNEARPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateNEARPERPInterface;
