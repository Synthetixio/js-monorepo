...
export interface PerpsV2ProxyMKRPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyMKRPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyMKRPERPInterface;
