...
export const name = 'PerpsV2OffchainDelayedOrderGBPPERP';
export const address = '0x0BB25623946960D8FB1696a9D70466766F2C8aa7';
...
export interface PerpsV2OffchainDelayedOrderGBPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2OffchainDelayedOrderGBPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2OffchainDelayedOrderGBPPERPInterface;
