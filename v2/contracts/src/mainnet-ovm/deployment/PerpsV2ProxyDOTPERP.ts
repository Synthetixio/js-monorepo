...
export interface PerpsV2ProxyDOTPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyDOTPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyDOTPERPInterface;
