...
export const address = '0xa95e89d93A7432A2Ce9453ec4E264940a96B364b';
...
export interface PerpsV2MarketLiquidateXAUPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateXAUPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateXAUPERPInterface;
