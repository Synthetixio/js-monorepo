...
export const name = 'PerpsV2MarketStateEOSPERP';
export const address = '0x1f53699b435326B6e264727b5504Cc28006Bed8B';
...
export interface PerpsV2MarketStateEOSPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateEOSPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateEOSPERPInterface;
