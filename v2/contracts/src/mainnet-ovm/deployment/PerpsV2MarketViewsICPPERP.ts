...
export const name = 'PerpsV2MarketViewsICPPERP';
export const address = '0xdd1122620688C25DF27DD405cf467cC9e5C0CC82';
...
export interface PerpsV2MarketViewsICPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsICPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsICPPERPInterface;
