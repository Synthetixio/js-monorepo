...
export const name = 'PerpsV2MarketViewsBTCPERP';
export const address = '0xb0A1d2c68Bf4D0980402DC220Ca6Ddeb8DbfbC56';
...
export interface PerpsV2MarketViewsBTCPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsBTCPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsBTCPERPInterface;
