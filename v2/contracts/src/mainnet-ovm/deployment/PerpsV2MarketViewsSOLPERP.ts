...
export const name = 'PerpsV2MarketViewsSOLPERP';
export const address = '0xFaf84737Dae0DA0c093BC172e32FB845016Df642';
...
export interface PerpsV2MarketViewsSOLPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsSOLPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsSOLPERPInterface;
