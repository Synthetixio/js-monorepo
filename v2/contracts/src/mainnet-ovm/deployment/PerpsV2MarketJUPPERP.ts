...
export interface PerpsV2MarketJUPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketJUPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketJUPPERPInterface;
