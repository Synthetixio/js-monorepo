...
export interface PerpsV2ProxyMEMEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyMEMEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyMEMEPERPInterface;
