...
export interface PerpsV2ProxyMAVPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyMAVPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyMAVPERPInterface;
