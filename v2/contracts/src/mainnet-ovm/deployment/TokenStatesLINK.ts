...
export interface TokenStatesLINKInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesLINK extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesLINKInterface;
