...
export const name = 'PerpsV2DelayedOrderSOLPERP';
export const address = '0xAEb1Cc5FD71CfFD1462808eE13b1051196bF6224';
...
export interface PerpsV2DelayedOrderSOLPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedOrderSOLPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedOrderSOLPERPInterface;
