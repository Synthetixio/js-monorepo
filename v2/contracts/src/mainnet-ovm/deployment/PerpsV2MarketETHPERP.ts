...
export const address = '0x35CcAC0A67D2a1EF1FDa8898AEcf1415FE6cf94c';
...
export interface PerpsV2MarketETHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketETHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketETHPERPInterface;
