...
export interface TokenStatesAVAXInterface extends utils.Interface {
  functions: {
...
export interface TokenStatesAVAX extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenStatesAVAXInterface;
