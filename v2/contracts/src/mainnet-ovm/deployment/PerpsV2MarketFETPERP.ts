...
export interface PerpsV2MarketFETPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketFETPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketFETPERPInterface;
