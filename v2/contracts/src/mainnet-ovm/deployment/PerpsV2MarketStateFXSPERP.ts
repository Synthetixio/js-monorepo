...
export const name = 'PerpsV2MarketStateFXSPERP';
export const address = '0xd9AC5ECbB704f0bdb0a96bEBfA3B79bE829d2bC1';
...
export interface PerpsV2MarketStateFXSPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateFXSPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateFXSPERPInterface;
