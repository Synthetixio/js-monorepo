...
export interface PerpsV2ProxyBTCPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyBTCPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyBTCPERPInterface;
