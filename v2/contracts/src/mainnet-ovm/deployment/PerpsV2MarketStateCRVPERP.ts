...
export const name = 'PerpsV2MarketStateCRVPERP';
export const address = '0x5A155c378d66d8EBa2262e744738a76d913E5945';
...
export interface PerpsV2MarketStateCRVPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateCRVPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateCRVPERPInterface;
