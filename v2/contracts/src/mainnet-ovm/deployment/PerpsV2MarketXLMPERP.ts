...
export interface PerpsV2MarketXLMPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketXLMPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketXLMPERPInterface;
