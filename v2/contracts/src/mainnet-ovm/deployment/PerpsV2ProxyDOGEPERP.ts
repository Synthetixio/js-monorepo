...
export interface PerpsV2ProxyDOGEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyDOGEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyDOGEPERPInterface;
