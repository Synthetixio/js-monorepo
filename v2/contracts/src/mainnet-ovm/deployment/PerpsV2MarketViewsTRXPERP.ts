...
export const name = 'PerpsV2MarketViewsTRXPERP';
export const address = '0xD1c8E9B404053560bc6A0302c4395FfB0FfD1C79';
...
export interface PerpsV2MarketViewsTRXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsTRXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsTRXPERPInterface;
