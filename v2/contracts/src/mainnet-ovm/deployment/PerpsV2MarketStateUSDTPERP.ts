...
export const name = 'PerpsV2MarketStateUSDTPERP';
export const address = '0xC2231D2cAdDBee015AeDddd3F0EE3874E3bd1d59';
...
export interface PerpsV2MarketStateUSDTPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateUSDTPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateUSDTPERPInterface;
