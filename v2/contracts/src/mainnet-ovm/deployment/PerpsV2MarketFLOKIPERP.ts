...
export interface PerpsV2MarketFLOKIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketFLOKIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketFLOKIPERPInterface;
