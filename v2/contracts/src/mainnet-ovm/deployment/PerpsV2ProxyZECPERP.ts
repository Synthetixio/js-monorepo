...
export interface PerpsV2ProxyZECPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyZECPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyZECPERPInterface;
