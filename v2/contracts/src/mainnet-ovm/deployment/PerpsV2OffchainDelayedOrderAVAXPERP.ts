...
export const name = 'PerpsV2OffchainDelayedOrderAVAXPERP';
export const address = '0xF7df260a4F46Eaf5A82589B9e9D3879e6FCee431';
...
export interface PerpsV2OffchainDelayedOrderAVAXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2OffchainDelayedOrderAVAXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2OffchainDelayedOrderAVAXPERPInterface;
