...
export const name = 'PerpsV2DelayedOrderATOMPERP';
export const address = '0xC0204F82ce1e25d15D2cE8DC1deA3f319BB64a8F';
...
export interface PerpsV2DelayedOrderATOMPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedOrderATOMPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedOrderATOMPERPInterface;
