...
export interface PerpsV2ProxyKNCPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyKNCPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyKNCPERPInterface;
