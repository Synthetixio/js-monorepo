...
export interface PerpsV2ProxyINJPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyINJPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyINJPERPInterface;
