...
export const name = 'PerpsV2DelayedOrderFLOWPERP';
export const address = '0xB9202087852298E5e2ebC0c30758fA4E07faf6fB';
...
export interface PerpsV2DelayedOrderFLOWPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedOrderFLOWPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedOrderFLOWPERPInterface;
