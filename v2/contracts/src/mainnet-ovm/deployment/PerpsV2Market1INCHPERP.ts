...
export interface PerpsV2Market1INCHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2Market1INCHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2Market1INCHPERPInterface;
