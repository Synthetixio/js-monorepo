...
export interface PerpsV2ProxyXTZPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyXTZPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyXTZPERPInterface;
