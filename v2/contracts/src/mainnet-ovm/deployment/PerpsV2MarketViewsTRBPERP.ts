...
export const name = 'PerpsV2MarketViewsTRBPERP';
export const address = '0x7bfa1D23Ec09cCCEF678c0175794Ef9e9dc11d18';
...
export interface PerpsV2MarketViewsTRBPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsTRBPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsTRBPERPInterface;
