...
export const address = '0x4F5f4617482b6399d63329c5070E6f37020dE286';
...
export interface PerpsV2MarketOPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketOPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketOPPERPInterface;
