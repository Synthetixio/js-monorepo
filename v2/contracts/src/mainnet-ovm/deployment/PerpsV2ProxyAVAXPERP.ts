...
export interface PerpsV2ProxyAVAXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyAVAXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyAVAXPERPInterface;
