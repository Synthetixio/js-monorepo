...
export const name = 'PerpsV2MarketStateETHBTCPERP';
export const address = '0xd10cd91683301c8C15eDA40F59e73d1b0BcfECDD';
...
export interface PerpsV2MarketStateETHBTCPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateETHBTCPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateETHBTCPERPInterface;
