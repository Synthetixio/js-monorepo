...
export const name = 'PerpsV2MarketStateRNDRPERP';
export const address = '0x82DCd3e7224DDA8dF6A746d70F1Cce80df4384c2';
...
export interface PerpsV2MarketStateRNDRPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateRNDRPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateRNDRPERPInterface;
