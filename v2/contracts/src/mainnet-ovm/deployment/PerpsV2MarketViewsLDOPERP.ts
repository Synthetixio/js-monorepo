...
export const name = 'PerpsV2MarketViewsLDOPERP';
export const address = '0xEbf81425e81e2A879C139DB3B3891B0A635dCF7F';
...
export interface PerpsV2MarketViewsLDOPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsLDOPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsLDOPERPInterface;
