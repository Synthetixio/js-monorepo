...
export const name = 'PerpsV2OffchainDelayedOrderNEARPERP';
export const address = '0xBF3B13F155070a61156f261b26D0Eb06f629C2e6';
...
export interface PerpsV2OffchainDelayedOrderNEARPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2OffchainDelayedOrderNEARPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2OffchainDelayedOrderNEARPERPInterface;
