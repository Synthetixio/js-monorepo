...
export interface SynthsINRInterface extends utils.Interface {
  functions: {
...
export interface SynthsINR extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SynthsINRInterface;
