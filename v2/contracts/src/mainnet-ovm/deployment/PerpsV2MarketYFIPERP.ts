...
export interface PerpsV2MarketYFIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketYFIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketYFIPERPInterface;
