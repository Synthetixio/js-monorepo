...
export interface PerpsV2ProxyATOMPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyATOMPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyATOMPERPInterface;
