...
export const address = '0x22AF5e22F07715fa2e267D2B49062949F71474B6';
...
export interface PerpsV2MarketXAUPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketXAUPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketXAUPERPInterface;
