...
export interface PerpsV2ProxyPERPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyPERPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyPERPPERPInterface;
