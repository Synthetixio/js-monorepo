...
export const name = 'PerpsV2MarketStateIMXPERP';
export const address = '0x4AfD66f7379449a73C4848B30DBeb93016346FBE';
...
export interface PerpsV2MarketStateIMXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateIMXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateIMXPERPInterface;
