...
export interface PerpsV2MarketRNDRPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketRNDRPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketRNDRPERPInterface;
