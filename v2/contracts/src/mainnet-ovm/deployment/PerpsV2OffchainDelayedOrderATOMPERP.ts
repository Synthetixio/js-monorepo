...
export const name = 'PerpsV2OffchainDelayedOrderATOMPERP';
export const address = '0x14688DFAa8b4085DA485579f72F3DE467485411a';
...
export interface PerpsV2OffchainDelayedOrderATOMPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2OffchainDelayedOrderATOMPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2OffchainDelayedOrderATOMPERPInterface;
