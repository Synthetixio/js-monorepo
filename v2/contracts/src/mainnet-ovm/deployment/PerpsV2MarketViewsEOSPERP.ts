...
export const name = 'PerpsV2MarketViewsEOSPERP';
export const address = '0x86508410Fd82c863920f194DA49a0835717c3673';
...
export interface PerpsV2MarketViewsEOSPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsEOSPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsEOSPERPInterface;
