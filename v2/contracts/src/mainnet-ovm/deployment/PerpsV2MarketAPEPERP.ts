...
export const address = '0x3f8dc633227DeC2E4a52cE8dB91c4858A8E3Ae78';
...
export interface PerpsV2MarketAPEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketAPEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketAPEPERPInterface;
