...
export const name = 'PerpsV2DelayedOrderXAUPERP';
export const address = '0x5AE6b5DD28F44689e4D17F47aeF1f863C36Df556';
...
export interface PerpsV2DelayedOrderXAUPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedOrderXAUPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedOrderXAUPERPInterface;
