...
export const name = 'PerpsV2MarketStateZECPERP';
export const address = '0xe94afDEd9CB9AB143E8cCc8C7439794E8C41F1A6';
...
export interface PerpsV2MarketStateZECPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateZECPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateZECPERPInterface;
