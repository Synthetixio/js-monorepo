...
export interface PerpsV2DelayedIntentPENDLEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedIntentPENDLEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedIntentPENDLEPERPInterface;
