...
export const name = 'PerpsV2MarketViewsAPEPERP';
export const address = '0x74DCCf74644485A6920d0CFE1A4D34B2F4216181';
...
export interface PerpsV2MarketViewsAPEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsAPEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsAPEPERPInterface;
