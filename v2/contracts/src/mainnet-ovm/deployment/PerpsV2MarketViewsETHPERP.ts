...
export const name = 'PerpsV2MarketViewsETHPERP';
export const address = '0xa1245E5B52555e40aa8A3Ffb95C5C426c7c7ef12';
...
export interface PerpsV2MarketViewsETHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsETHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsETHPERPInterface;
