...
export const name = 'PerpsV2MarketStateMATICPERP';
export const address = '0xfC99d08D8ff69e31095E7372620369Fa92c82960';
...
export interface PerpsV2MarketStateMATICPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateMATICPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateMATICPERPInterface;
