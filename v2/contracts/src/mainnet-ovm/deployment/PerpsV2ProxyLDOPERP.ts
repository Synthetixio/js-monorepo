...
export interface PerpsV2ProxyLDOPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyLDOPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyLDOPERPInterface;
