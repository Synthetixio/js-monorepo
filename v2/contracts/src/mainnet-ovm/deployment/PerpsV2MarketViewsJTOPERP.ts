...
export const name = 'PerpsV2MarketViewsJTOPERP';
export const address = '0x92E1D720a055604C72Ffe14c4e51A1c5d67D5D3A';
...
export interface PerpsV2MarketViewsJTOPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsJTOPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsJTOPERPInterface;
