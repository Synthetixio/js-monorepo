...
export const name = 'PerpsV2MarketViewsADAPERP';
export const address = '0x703f070BC98f835EDc5DE183A537d837a7c65C9F';
...
export interface PerpsV2MarketViewsADAPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsADAPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsADAPERPInterface;
