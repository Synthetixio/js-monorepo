...
export const address = '0x184D5A9f37D0ca2151102958D174E21Db6605069';
...
export interface PerpsV2MarketViewsLTCPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsLTCPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsLTCPERPInterface;
