...
export interface PerpsV2MarketGRTPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketGRTPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketGRTPERPInterface;
