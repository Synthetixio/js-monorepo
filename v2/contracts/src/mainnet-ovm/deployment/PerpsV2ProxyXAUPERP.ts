...
export interface PerpsV2ProxyXAUPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyXAUPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyXAUPERPInterface;
