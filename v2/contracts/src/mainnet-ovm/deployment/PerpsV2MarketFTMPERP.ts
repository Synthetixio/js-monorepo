...
export const address = '0x16D1cEE82608b12C4116626DCc1E69685561bf4c';
...
export interface PerpsV2MarketFTMPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketFTMPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketFTMPERPInterface;
