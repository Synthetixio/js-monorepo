...
export const name = 'FuturesMarketDYDX';
export const address = '0x10305C1854d6DB8A1060dF60bDF8A8B2981249Cf';
...
export interface FuturesMarketDYDXInterface extends utils.Interface {
  functions: {
...
export interface FuturesMarketDYDX extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FuturesMarketDYDXInterface;
