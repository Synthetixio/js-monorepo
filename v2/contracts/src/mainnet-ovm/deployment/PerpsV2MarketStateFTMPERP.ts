...
export const name = 'PerpsV2MarketStateFTMPERP';
export const address = '0xe76DF4d2554C74B746c5A1Df8EAA4eA8F657916d';
...
export interface PerpsV2MarketStateFTMPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateFTMPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateFTMPERPInterface;
