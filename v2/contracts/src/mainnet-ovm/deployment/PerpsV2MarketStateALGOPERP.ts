...
export const name = 'PerpsV2MarketStateALGOPERP';
export const address = '0xd856b45d4D9671482e53E705058aF3fF09000A28';
...
export interface PerpsV2MarketStateALGOPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateALGOPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateALGOPERPInterface;
