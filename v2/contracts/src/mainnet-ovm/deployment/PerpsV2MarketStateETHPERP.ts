...
export const name = 'PerpsV2MarketStateETHPERP';
export const address = '0x038dC05D68ED32F23e6856c0D44b0696B325bfC8';
...
export interface PerpsV2MarketStateETHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateETHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateETHPERPInterface;
