...
export const name = 'PerpsV2DelayedOrderLINKPERP';
export const address = '0x45C93D2C1994a70fD2Af98DA6ba100953b96A768';
...
export interface PerpsV2DelayedOrderLINKPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedOrderLINKPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedOrderLINKPERPInterface;
