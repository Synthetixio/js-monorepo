...
export interface PerpsV2MarketWLDPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketWLDPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketWLDPERPInterface;
