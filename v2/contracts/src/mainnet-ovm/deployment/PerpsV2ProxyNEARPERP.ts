...
export interface PerpsV2ProxyNEARPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyNEARPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyNEARPERPInterface;
