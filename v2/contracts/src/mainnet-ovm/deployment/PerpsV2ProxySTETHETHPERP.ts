...
export interface PerpsV2ProxySTETHETHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxySTETHETHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxySTETHETHPERPInterface;
