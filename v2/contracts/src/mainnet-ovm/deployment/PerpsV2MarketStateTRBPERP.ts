...
export const name = 'PerpsV2MarketStateTRBPERP';
export const address = '0x4B786a8b4b7ca90f9857776b0B888cED53CFeeF0';
...
export interface PerpsV2MarketStateTRBPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateTRBPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateTRBPERPInterface;
