...
export interface PerpsV2MarketICPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketICPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketICPPERPInterface;
