...
export const address = '0xc98e2439711EDf1Ab1E8BD23133145c3E1287f94';
...
export interface PerpsV2MarketLINKPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLINKPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLINKPERPInterface;
