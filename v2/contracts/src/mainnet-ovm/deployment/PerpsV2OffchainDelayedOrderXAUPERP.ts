...
export const name = 'PerpsV2OffchainDelayedOrderXAUPERP';
export const address = '0xf8B9Dd242BDAF6242cb783F02b49D1Dd9126DE5c';
...
export interface PerpsV2OffchainDelayedOrderXAUPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2OffchainDelayedOrderXAUPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2OffchainDelayedOrderXAUPERPInterface;
