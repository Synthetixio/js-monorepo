...
export interface PerpsV2MarketRPLPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketRPLPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketRPLPERPInterface;
