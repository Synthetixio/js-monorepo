...
export const name = 'PerpsV2MarketViewsCVXPERP';
export const address = '0xE854473Fc57DB647f957d813044649200C6E1c4e';
...
export interface PerpsV2MarketViewsCVXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsCVXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsCVXPERPInterface;
