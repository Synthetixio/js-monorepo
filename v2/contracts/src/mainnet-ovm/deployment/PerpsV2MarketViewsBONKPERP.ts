...
export const name = 'PerpsV2MarketViewsBONKPERP';
export const address = '0xE0a9be89b352014028dA9837233168DD5CCEC9B1';
...
export interface PerpsV2MarketViewsBONKPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsBONKPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsBONKPERPInterface;
