...
export const name = 'PerpsV2MarketStateBNBPERP';
export const address = '0x7b75C4857E84C8421D422E06447A7Fb03c398eDd';
...
export interface PerpsV2MarketStateBNBPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateBNBPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateBNBPERPInterface;
