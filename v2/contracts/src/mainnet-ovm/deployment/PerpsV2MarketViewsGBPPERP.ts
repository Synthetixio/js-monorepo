...
export const name = 'PerpsV2MarketViewsGBPPERP';
export const address = '0x3f30190416EBdE7F50749cf3579Af1beeF2E7Fa8';
...
export interface PerpsV2MarketViewsGBPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsGBPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsGBPPERPInterface;
