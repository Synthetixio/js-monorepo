...
export const name = 'PerpsV2OffchainDelayedOrderBNBPERP';
export const address = '0x8c2c26494eAe20A8a22f94ED5Fa4B104FAD6bcca';
...
export interface PerpsV2OffchainDelayedOrderBNBPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2OffchainDelayedOrderBNBPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2OffchainDelayedOrderBNBPERPInterface;
