...
export interface PerpsV2DelayedExecutionUNIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionUNIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionUNIPERPInterface;
