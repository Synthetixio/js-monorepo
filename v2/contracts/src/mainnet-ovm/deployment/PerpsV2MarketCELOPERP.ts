...
export interface PerpsV2MarketCELOPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketCELOPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketCELOPERPInterface;
