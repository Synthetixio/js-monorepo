...
export const name = 'PerpsV2MarketViewsSTETHPERP';
export const address = '0x0060b9F4eaA97b310Bf74947EdCdFE2967e54D7d';
...
export interface PerpsV2MarketViewsSTETHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsSTETHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsSTETHPERPInterface;
