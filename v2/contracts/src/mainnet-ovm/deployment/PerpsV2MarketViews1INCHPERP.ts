...
export const name = 'PerpsV2MarketViews1INCHPERP';
export const address = '0x23D5291fEa095D8851cE3bB711a10b4982923d9a';
...
export interface PerpsV2MarketViews1INCHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViews1INCHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViews1INCHPERPInterface;
