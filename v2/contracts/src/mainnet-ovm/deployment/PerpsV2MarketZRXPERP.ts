...
export interface PerpsV2MarketZRXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketZRXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketZRXPERPInterface;
