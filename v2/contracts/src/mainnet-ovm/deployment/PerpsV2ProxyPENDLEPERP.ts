...
export interface PerpsV2ProxyPENDLEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyPENDLEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyPENDLEPERPInterface;
