...
export const address = '0x8bE1893E1D29FCf2B966Cdd083efe30DBf78D7f6';
...
export interface PerpsV2MarketBTCPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketBTCPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketBTCPERPInterface;
