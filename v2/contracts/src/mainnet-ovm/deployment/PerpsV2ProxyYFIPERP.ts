...
export interface PerpsV2ProxyYFIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyYFIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyYFIPERPInterface;
