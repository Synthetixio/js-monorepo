...
export const name = 'PerpsV2DelayedOrderDOGEPERP';
export const address = '0x62B6f3733AB95Ec88864F03f758DE4377d6C751d';
...
export interface PerpsV2DelayedOrderDOGEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedOrderDOGEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedOrderDOGEPERPInterface;
