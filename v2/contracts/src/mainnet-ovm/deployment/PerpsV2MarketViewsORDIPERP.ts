...
export const name = 'PerpsV2MarketViewsORDIPERP';
export const address = '0x6aEa7024E001560Ebf4F634d3EBfC8403FE0c7BF';
...
export interface PerpsV2MarketViewsORDIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsORDIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsORDIPERPInterface;
