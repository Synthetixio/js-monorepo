...
export interface PerpsV2ProxyEOSPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyEOSPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyEOSPERPInterface;
