...
export const name = 'PerpsV2MarketStateOPPERP';
export const address = '0xa26c97A0c9788e937986ee6276f3762c20C06ef5';
...
export interface PerpsV2MarketStateOPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateOPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateOPPERPInterface;
