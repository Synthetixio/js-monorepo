...
export const name = 'PerpsV2DelayedOrderMATICPERP';
export const address = '0xDF89210B03E319B08EC0cC73C4B50468306e1252';
...
export interface PerpsV2DelayedOrderMATICPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedOrderMATICPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedOrderMATICPERPInterface;
