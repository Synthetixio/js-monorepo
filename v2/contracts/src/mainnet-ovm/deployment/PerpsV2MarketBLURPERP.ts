...
export interface PerpsV2MarketBLURPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketBLURPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketBLURPERPInterface;
