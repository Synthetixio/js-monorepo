...
export const name = 'PerpsV2MarketViewsENJPERP';
export const address = '0x04631B9297919E98334C5AbAa762C48af071b4ef';
...
export interface PerpsV2MarketViewsENJPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsENJPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsENJPERPInterface;
