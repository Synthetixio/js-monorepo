...
export const name = 'PerpsV2OffchainDelayedOrderAUDPERP';
export const address = '0x2A656E9618185782A638c86C64b5702854DDB11A';
...
export interface PerpsV2OffchainDelayedOrderAUDPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2OffchainDelayedOrderAUDPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2OffchainDelayedOrderAUDPERPInterface;
