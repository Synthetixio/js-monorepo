...
export const name = 'PerpsV2MarketViewsAUDPERP';
export const address = '0x7D0256E0936103b32AAD59E80257B59E988E75e2';
...
export interface PerpsV2MarketViewsAUDPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsAUDPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsAUDPERPInterface;
