...
export const name = 'PerpsV2DelayedOrderOPPERP';
export const address = '0x3c30CBd400f8e7c099ab27cF28DA843cD4433FFE';
...
export interface PerpsV2DelayedOrderOPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedOrderOPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedOrderOPPERPInterface;
