...
export const name = 'PerpsV2MarketViewsDOGEPERP';
export const address = '0x9c79C19FF4d1a6531D9a4F91e96534F5D002dF8B';
...
export interface PerpsV2MarketViewsDOGEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsDOGEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsDOGEPERPInterface;
