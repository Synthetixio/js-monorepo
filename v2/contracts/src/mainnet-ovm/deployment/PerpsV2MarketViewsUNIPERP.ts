...
export const name = 'PerpsV2MarketViewsUNIPERP';
export const address = '0xda3a5e9502b23Eaedc8cC048998893013e09787d';
...
export interface PerpsV2MarketViewsUNIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsUNIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsUNIPERPInterface;
