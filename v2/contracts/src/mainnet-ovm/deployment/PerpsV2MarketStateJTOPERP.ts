...
export const name = 'PerpsV2MarketStateJTOPERP';
export const address = '0xbC2FDA8D78A9a7F0AFEfD45EE5c4A78f02088C10';
...
export interface PerpsV2MarketStateJTOPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateJTOPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateJTOPERPInterface;
