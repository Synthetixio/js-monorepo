...
export const name = 'PerpsV2MarketStateSOLPERP';
export const address = '0x5da48D842542eF497ad68FAEd3480b3B1609Afe5';
...
export interface PerpsV2MarketStateSOLPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateSOLPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateSOLPERPInterface;
