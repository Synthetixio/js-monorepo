...
export interface PerpsV2ProxyZRXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyZRXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyZRXPERPInterface;
