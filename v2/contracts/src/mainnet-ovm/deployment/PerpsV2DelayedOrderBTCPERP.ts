...
export const name = 'PerpsV2DelayedOrderBTCPERP';
export const address = '0xD8c3F087000DC990Fc84a776aED78d31507F716B';
...
export interface PerpsV2DelayedOrderBTCPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedOrderBTCPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedOrderBTCPERPInterface;
