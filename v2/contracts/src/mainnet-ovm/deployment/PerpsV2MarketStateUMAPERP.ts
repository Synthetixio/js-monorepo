...
export const name = 'PerpsV2MarketStateUMAPERP';
export const address = '0x595f37E1b21870571eE99fbe815D6790D817C0Ba';
...
export interface PerpsV2MarketStateUMAPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateUMAPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateUMAPERPInterface;
