...
export const name = 'PerpsV2MarketViewsMEMEPERP';
export const address = '0x65AC63AaF11dF18d392469eD2D8CaF8E2E40E788';
...
export interface PerpsV2MarketViewsMEMEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsMEMEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsMEMEPERPInterface;
