...
export const name = 'PerpsV2MarketStateSTETHETHPERP';
export const address = '0x2EC454957C0e66266398076f066fAaC77c48d88d';
...
export interface PerpsV2MarketStateSTETHETHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateSTETHETHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateSTETHETHPERPInterface;
