...
export const name = 'PerpsV2OffchainDelayedOrderARBPERP';
export const address = '0x5d89892BCa7aa5619fd6168D38F73bb84D777e9C';
...
export interface PerpsV2OffchainDelayedOrderARBPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2OffchainDelayedOrderARBPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2OffchainDelayedOrderARBPERPInterface;
