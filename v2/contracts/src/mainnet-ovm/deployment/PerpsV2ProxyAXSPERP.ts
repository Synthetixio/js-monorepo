...
export interface PerpsV2ProxyAXSPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyAXSPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyAXSPERPInterface;
