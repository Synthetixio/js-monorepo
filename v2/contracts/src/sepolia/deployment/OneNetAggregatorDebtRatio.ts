...
export interface OneNetAggregatorDebtRatioInterface extends utils.Interface {
  functions: {
...
export interface OneNetAggregatorDebtRatio extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OneNetAggregatorDebtRatioInterface;
