...
export interface PerpsV2ProxyALGOPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyALGOPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyALGOPERPInterface;
