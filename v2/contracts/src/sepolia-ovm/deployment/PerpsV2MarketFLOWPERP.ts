...
export interface PerpsV2MarketFLOWPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketFLOWPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketFLOWPERPInterface;
