...
export interface PerpsV2ProxyJUPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyJUPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyJUPPERPInterface;
