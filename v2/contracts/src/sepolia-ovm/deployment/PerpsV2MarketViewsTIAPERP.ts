...
export const name = 'PerpsV2MarketViewsTIAPERP';
export const address = '0x66CD99A57fD8B4C994E25fAd5f8b03b3d84a37Ac';
...
export interface PerpsV2MarketViewsTIAPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsTIAPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsTIAPERPInterface;
