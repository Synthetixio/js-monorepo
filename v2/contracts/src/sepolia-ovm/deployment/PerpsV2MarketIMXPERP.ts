...
export interface PerpsV2MarketIMXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketIMXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketIMXPERPInterface;
