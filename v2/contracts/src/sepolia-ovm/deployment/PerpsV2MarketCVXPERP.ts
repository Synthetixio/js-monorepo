...
export interface PerpsV2MarketCVXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketCVXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketCVXPERPInterface;
