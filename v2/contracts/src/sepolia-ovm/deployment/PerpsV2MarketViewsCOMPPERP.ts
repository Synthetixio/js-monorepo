...
export const name = 'PerpsV2MarketViewsCOMPPERP';
export const address = '0xE855064409394F6C0409e3c50D9CC3f98CAF3a04';
...
export interface PerpsV2MarketViewsCOMPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsCOMPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsCOMPPERPInterface;
