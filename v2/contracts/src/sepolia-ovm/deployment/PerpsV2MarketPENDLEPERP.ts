...
export interface PerpsV2MarketPENDLEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketPENDLEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketPENDLEPERPInterface;
