...
export const name = 'PerpsV2MarketViewsUSDTPERP';
export const address = '0x50653FC9BD9aE72FA199e2F90B81970332db9E9F';
...
export interface PerpsV2MarketViewsUSDTPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsUSDTPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsUSDTPERPInterface;
