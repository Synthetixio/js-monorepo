...
export const name = 'PerpsV2MarketViewsGMXPERP';
export const address = '0x4Ba3c1B16d405DA7a9E0DB9Bb81A2968C202B1cE';
...
export interface PerpsV2MarketViewsGMXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsGMXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsGMXPERPInterface;
