...
export const name = 'PerpsV2MarketViewsJUPPERP';
export const address = '0xF93c98Fd66a710b39ee2D982CB82fDFb3EC29EBd';
...
export interface PerpsV2MarketViewsJUPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsJUPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsJUPPERPInterface;
