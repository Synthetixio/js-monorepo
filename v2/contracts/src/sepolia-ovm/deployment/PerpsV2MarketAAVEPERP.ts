...
export interface PerpsV2MarketAAVEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketAAVEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketAAVEPERPInterface;
