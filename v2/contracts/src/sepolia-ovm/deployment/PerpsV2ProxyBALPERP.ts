...
export interface PerpsV2ProxyBALPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyBALPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyBALPERPInterface;
