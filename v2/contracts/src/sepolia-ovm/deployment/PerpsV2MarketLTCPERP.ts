...
export interface PerpsV2MarketLTCPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLTCPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLTCPERPInterface;
