...
export const name = 'PerpsV2MarketViewsZRXPERP';
export const address = '0x02442c278B70e5869FAdad11e255b5b24cA04BC3';
...
export interface PerpsV2MarketViewsZRXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsZRXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsZRXPERPInterface;
