...
export interface PerpsV2MarketDYDXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketDYDXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketDYDXPERPInterface;
