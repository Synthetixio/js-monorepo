...
export const name = 'PerpsV2MarketStateFETPERP';
export const address = '0x99C436Df9F3EAaEb5c7BB4ee627a696e9691D7B0';
...
export interface PerpsV2MarketStateFETPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateFETPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateFETPERPInterface;
