...
export interface PerpsV2ProxyENJPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyENJPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyENJPERPInterface;
