...
export interface PerpsV2MarketXMRPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketXMRPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketXMRPERPInterface;
