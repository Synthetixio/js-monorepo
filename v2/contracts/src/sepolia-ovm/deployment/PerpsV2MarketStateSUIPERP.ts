...
export const name = 'PerpsV2MarketStateSUIPERP';
export const address = '0xab507bdf251AD73665a4846475D8Fa7B6c463c44';
...
export interface PerpsV2MarketStateSUIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateSUIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateSUIPERPInterface;
