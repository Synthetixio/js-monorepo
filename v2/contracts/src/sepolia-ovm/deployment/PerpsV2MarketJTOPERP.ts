...
export interface PerpsV2MarketJTOPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketJTOPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketJTOPERPInterface;
