...
export const name = 'PerpsV2MarketStatePENDLEPERP';
export const address = '0x2997Bcd284dFE0D5aBFF0958d2202e417E9A1627';
...
export interface PerpsV2MarketStatePENDLEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStatePENDLEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStatePENDLEPERPInterface;
