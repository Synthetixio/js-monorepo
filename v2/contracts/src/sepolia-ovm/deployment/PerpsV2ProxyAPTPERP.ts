...
export interface PerpsV2ProxyAPTPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyAPTPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyAPTPERPInterface;
