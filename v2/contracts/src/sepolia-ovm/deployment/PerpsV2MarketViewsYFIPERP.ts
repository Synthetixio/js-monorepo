...
export const name = 'PerpsV2MarketViewsYFIPERP';
export const address = '0xe49e38957bb3d8aa12354B9017904aAe84417B4e';
...
export interface PerpsV2MarketViewsYFIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsYFIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsYFIPERPInterface;
