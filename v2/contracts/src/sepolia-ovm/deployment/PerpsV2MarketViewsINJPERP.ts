...
export const name = 'PerpsV2MarketViewsINJPERP';
export const address = '0x27772223122CEfB7430C3875466013049bd13c91';
...
export interface PerpsV2MarketViewsINJPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsINJPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsINJPERPInterface;
