...
export interface PerpsV2MarketLiquidateMKRPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateMKRPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateMKRPERPInterface;
