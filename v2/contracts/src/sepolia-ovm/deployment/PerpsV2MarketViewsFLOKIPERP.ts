...
export const name = 'PerpsV2MarketViewsFLOKIPERP';
export const address = '0x66D1d2f36B29b2dC334aE3BB4c79b65D044Dd0e5';
...
export interface PerpsV2MarketViewsFLOKIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsFLOKIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsFLOKIPERPInterface;
