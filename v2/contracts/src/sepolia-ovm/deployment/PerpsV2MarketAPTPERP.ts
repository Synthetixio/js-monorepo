...
export interface PerpsV2MarketAPTPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketAPTPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketAPTPERPInterface;
