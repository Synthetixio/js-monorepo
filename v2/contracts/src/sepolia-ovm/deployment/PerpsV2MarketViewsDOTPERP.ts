...
export const name = 'PerpsV2MarketViewsDOTPERP';
export const address = '0x82eb5cc9E3CBCbCA6b2571edc54886650aB891FD';
...
export interface PerpsV2MarketViewsDOTPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsDOTPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsDOTPERPInterface;
