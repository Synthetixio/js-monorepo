...
export interface PerpsV2ProxyETHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyETHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyETHPERPInterface;
