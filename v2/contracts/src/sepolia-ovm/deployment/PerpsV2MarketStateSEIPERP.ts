...
export const name = 'PerpsV2MarketStateSEIPERP';
export const address = '0x86771CAc78a8Ce62CBCFAD639dFdeB9443856fAb';
...
export interface PerpsV2MarketStateSEIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateSEIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateSEIPERPInterface;
