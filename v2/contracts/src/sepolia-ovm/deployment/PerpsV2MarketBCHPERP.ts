...
export interface PerpsV2MarketBCHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketBCHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketBCHPERPInterface;
