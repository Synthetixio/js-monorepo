...
export const name = 'PerpsV2MarketViewsSEIPERP';
export const address = '0x7735d84648548791164263742D1AfFe49e4D9B2b';
...
export interface PerpsV2MarketViewsSEIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsSEIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsSEIPERPInterface;
