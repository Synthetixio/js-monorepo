...
export interface PerpsV2ProxyXMRPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyXMRPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyXMRPERPInterface;
