...
export interface PerpsV2MarketSTRKPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketSTRKPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketSTRKPERPInterface;
