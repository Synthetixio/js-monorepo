...
export interface PerpsV2ProxyLTCPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyLTCPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyLTCPERPInterface;
