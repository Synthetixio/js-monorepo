...
export interface PerpsV2ProxySTETHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxySTETHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxySTETHPERPInterface;
