...
export interface PerpsV2ProxyXAGPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyXAGPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyXAGPERPInterface;
