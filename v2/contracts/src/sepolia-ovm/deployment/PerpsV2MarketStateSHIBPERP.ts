...
export const name = 'PerpsV2MarketStateSHIBPERP';
export const address = '0x4926222EDDa82965Aa08080f281928f8cba5922A';
...
export interface PerpsV2MarketStateSHIBPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateSHIBPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateSHIBPERPInterface;
