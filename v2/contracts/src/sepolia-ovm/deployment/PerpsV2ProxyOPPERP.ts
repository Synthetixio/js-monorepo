...
export interface PerpsV2ProxyOPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyOPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyOPPERPInterface;
