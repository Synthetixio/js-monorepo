...
export const name = 'PerpsV2MarketViewsRNDRPERP';
export const address = '0xA2C8aC77ec8D0F2c2A1cB16b80fAddDD02093366';
...
export interface PerpsV2MarketViewsRNDRPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsRNDRPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsRNDRPERPInterface;
