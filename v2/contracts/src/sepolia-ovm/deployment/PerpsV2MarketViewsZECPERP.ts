...
export const name = 'PerpsV2MarketViewsZECPERP';
export const address = '0x7E038f24235084d518955A572082093c84B16441';
...
export interface PerpsV2MarketViewsZECPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsZECPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsZECPERPInterface;
