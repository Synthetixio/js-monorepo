...
export interface PerpsV2MarketPEPEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketPEPEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketPEPEPERPInterface;
