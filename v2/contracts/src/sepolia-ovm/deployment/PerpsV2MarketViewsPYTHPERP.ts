...
export const name = 'PerpsV2MarketViewsPYTHPERP';
export const address = '0x6aadeFe139b7F637d5D9dd4ab7a0d9d63bb46965';
...
export interface PerpsV2MarketViewsPYTHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsPYTHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsPYTHPERPInterface;
