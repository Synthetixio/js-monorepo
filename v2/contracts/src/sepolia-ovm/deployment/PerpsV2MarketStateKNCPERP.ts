...
export const name = 'PerpsV2MarketStateKNCPERP';
export const address = '0x05847D5C5e44Db9A6683E0a73A752792c0f35CfF';
...
export interface PerpsV2MarketStateKNCPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateKNCPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateKNCPERPInterface;
