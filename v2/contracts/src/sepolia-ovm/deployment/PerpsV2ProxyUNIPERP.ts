...
export interface PerpsV2ProxyUNIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyUNIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyUNIPERPInterface;
