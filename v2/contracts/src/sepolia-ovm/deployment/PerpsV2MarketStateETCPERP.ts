...
export const address = '0xc85D9ACd99E9216Ba2fcef58f5355776aCF2252b';
...
export interface PerpsV2MarketStateETCPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateETCPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateETCPERPInterface;
