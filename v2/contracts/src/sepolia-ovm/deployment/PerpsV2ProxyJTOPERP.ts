...
export interface PerpsV2ProxyJTOPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyJTOPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyJTOPERPInterface;
