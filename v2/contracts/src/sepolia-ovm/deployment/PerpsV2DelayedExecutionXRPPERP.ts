...
export interface PerpsV2DelayedExecutionXRPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionXRPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionXRPPERPInterface;
