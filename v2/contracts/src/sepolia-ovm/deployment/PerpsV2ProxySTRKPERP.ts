...
export interface PerpsV2ProxySTRKPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxySTRKPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxySTRKPERPInterface;
