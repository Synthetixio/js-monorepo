...
export interface PerpsV2ProxyMATICPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyMATICPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyMATICPERPInterface;
