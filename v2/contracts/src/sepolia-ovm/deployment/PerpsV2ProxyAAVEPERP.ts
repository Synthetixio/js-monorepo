...
export interface PerpsV2ProxyAAVEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyAAVEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyAAVEPERPInterface;
