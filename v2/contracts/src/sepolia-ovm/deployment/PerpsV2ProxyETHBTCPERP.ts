...
export interface PerpsV2ProxyETHBTCPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyETHBTCPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyETHBTCPERPInterface;
