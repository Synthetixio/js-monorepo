...
export interface PerpsV2MarketAUDPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketAUDPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketAUDPERPInterface;
