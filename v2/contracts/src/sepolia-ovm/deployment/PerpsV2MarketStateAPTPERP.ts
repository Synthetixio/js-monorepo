...
export const name = 'PerpsV2MarketStateAPTPERP';
export const address = '0xbCfeFE75a5bDEd6e6739e9EcD956fABeEFBA183B';
...
export interface PerpsV2MarketStateAPTPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateAPTPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateAPTPERPInterface;
