...
export const name = 'PerpsV2MarketStateGMXPERP';
export const address = '0x13B0D3d8De76cD9f8C2c768f8FA17eF68E719847';
...
export interface PerpsV2MarketStateGMXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateGMXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateGMXPERPInterface;
