...
export interface PerpsV2ProxyFXSPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyFXSPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyFXSPERPInterface;
