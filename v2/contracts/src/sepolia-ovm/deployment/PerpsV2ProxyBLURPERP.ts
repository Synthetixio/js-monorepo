...
export interface PerpsV2ProxyBLURPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyBLURPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyBLURPERPInterface;
