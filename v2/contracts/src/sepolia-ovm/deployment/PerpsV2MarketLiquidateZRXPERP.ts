...
export interface PerpsV2MarketLiquidateZRXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateZRXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateZRXPERPInterface;
