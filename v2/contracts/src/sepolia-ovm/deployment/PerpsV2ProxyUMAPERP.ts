...
export interface PerpsV2ProxyUMAPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyUMAPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyUMAPERPInterface;
