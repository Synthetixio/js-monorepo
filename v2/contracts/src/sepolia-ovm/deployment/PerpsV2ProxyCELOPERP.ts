...
export interface PerpsV2ProxyCELOPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyCELOPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyCELOPERPInterface;
