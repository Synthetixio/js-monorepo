...
export interface PerpsV2ProxyCVXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyCVXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyCVXPERPInterface;
