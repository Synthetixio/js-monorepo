...
export interface PerpsV2MarketFILPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketFILPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketFILPERPInterface;
