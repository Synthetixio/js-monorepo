...
export const name = 'PerpsV2MarketViewsWLDPERP';
export const address = '0x0c58199F497AF36Ee508eD05f2b49114cF6BaD8e';
...
export interface PerpsV2MarketViewsWLDPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsWLDPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsWLDPERPInterface;
