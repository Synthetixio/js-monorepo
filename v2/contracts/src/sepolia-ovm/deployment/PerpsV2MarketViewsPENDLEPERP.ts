...
export const name = 'PerpsV2MarketViewsPENDLEPERP';
export const address = '0xC26e4f89b625E2b1BEF4365A3C7B1E0A996DC0a4';
...
export interface PerpsV2MarketViewsPENDLEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsPENDLEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsPENDLEPERPInterface;
