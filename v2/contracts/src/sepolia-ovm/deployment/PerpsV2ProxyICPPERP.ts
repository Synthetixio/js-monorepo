...
export interface PerpsV2ProxyICPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyICPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyICPPERPInterface;
