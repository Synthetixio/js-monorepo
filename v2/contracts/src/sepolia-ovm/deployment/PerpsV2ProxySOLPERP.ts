...
export interface PerpsV2ProxySOLPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxySOLPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxySOLPERPInterface;
