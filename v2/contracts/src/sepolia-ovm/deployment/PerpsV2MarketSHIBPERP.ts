...
export interface PerpsV2MarketSHIBPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketSHIBPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketSHIBPERPInterface;
