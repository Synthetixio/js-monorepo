...
export const name = 'PerpsV2MarketViewsBALPERP';
export const address = '0xb045cA31Ee8eeE63cd7cF8c9098910285d18d2d5';
...
export interface PerpsV2MarketViewsBALPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsBALPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsBALPERPInterface;
