...
export interface PerpsV2MarketMAVPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketMAVPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketMAVPERPInterface;
