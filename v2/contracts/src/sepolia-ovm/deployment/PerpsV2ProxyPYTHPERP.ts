...
export interface PerpsV2ProxyPYTHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyPYTHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyPYTHPERPInterface;
