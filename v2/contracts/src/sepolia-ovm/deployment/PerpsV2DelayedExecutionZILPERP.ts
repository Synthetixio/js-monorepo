...
export interface PerpsV2DelayedExecutionZILPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2DelayedExecutionZILPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2DelayedExecutionZILPERPInterface;
