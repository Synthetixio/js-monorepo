...
export const name = 'PerpsV2MarketViewsALGOPERP';
export const address = '0x9AcC73a2Daf1f533ec2900160cfF154dA7A9A145';
...
export interface PerpsV2MarketViewsALGOPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsALGOPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsALGOPERPInterface;
