...
export const name = 'PerpsV2MarketViewsCELOPERP';
export const address = '0x4B67d6051Bf3C16cf4Ba7cFADBf1eF3965af9d6c';
...
export interface PerpsV2MarketViewsCELOPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsCELOPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsCELOPERPInterface;
