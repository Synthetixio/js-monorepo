...
export interface PerpsV2ProxyTIAPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyTIAPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyTIAPERPInterface;
