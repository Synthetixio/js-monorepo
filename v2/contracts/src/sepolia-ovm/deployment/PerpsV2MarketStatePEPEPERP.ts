...
export const name = 'PerpsV2MarketStatePEPEPERP';
export const address = '0xFbE4FFA5e1844A4A2121086623125C99B2A322b9';
...
export interface PerpsV2MarketStatePEPEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStatePEPEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStatePEPEPERPInterface;
