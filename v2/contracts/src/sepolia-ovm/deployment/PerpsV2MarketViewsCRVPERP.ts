...
export const name = 'PerpsV2MarketViewsCRVPERP';
export const address = '0x00bE2cDcb46268FB5D4F6845413eEBA9B0cc9ae6';
...
export interface PerpsV2MarketViewsCRVPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsCRVPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsCRVPERPInterface;
