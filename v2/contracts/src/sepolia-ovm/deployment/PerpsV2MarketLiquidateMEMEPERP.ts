...
export interface PerpsV2MarketLiquidateMEMEPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateMEMEPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateMEMEPERPInterface;
