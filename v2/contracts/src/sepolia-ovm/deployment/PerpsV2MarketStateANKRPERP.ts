...
export const name = 'PerpsV2MarketStateANKRPERP';
export const address = '0x647A15Cba7F859F1192aDEEb2C36b6Ab39Ce071C';
...
export interface PerpsV2MarketStateANKRPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateANKRPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateANKRPERPInterface;
