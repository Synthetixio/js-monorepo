...
export interface PerpsV2ProxySEIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxySEIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxySEIPERPInterface;
