...
export const name = 'PerpsV2MarketViewsATOMPERP';
export const address = '0xa6E03c91AF7Ea284772000F809e30b9a8006d8c0';
...
export interface PerpsV2MarketViewsATOMPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketViewsATOMPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketViewsATOMPERPInterface;
