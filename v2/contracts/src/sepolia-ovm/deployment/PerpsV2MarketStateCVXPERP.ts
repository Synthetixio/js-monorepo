...
export const name = 'PerpsV2MarketStateCVXPERP';
export const address = '0xdA1FC750517AD0E23c8971AB7195109be2824343';
...
export interface PerpsV2MarketStateCVXPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateCVXPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateCVXPERPInterface;
