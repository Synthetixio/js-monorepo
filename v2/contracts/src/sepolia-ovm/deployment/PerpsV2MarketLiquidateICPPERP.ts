...
export interface PerpsV2MarketLiquidateICPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketLiquidateICPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketLiquidateICPPERPInterface;
