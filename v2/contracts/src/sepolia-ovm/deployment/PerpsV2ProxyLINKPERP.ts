...
export interface PerpsV2ProxyLINKPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyLINKPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyLINKPERPInterface;
