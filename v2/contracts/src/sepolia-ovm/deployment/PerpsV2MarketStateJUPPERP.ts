...
export const name = 'PerpsV2MarketStateJUPPERP';
export const address = '0xdb828a46226a555463993E78eAb127eC2b596A73';
...
export interface PerpsV2MarketStateJUPPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketStateJUPPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketStateJUPPERPInterface;
