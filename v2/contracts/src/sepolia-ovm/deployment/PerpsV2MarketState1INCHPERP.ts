...
export const name = 'PerpsV2MarketState1INCHPERP';
export const address = '0x7a1A217D5cF0ff084c3053bdd123D425bADb6488';
...
export interface PerpsV2MarketState1INCHPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketState1INCHPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketState1INCHPERPInterface;
