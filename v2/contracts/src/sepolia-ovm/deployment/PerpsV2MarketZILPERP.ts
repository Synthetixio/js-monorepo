...
export interface PerpsV2MarketZILPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketZILPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketZILPERPInterface;
