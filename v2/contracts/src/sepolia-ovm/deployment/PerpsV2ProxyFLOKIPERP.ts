...
export interface PerpsV2ProxyFLOKIPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyFLOKIPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyFLOKIPERPInterface;
