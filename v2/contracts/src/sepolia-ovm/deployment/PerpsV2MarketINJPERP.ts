...
export interface PerpsV2MarketINJPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketINJPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketINJPERPInterface;
