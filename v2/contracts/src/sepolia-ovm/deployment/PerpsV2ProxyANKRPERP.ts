...
export interface PerpsV2ProxyANKRPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2ProxyANKRPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2ProxyANKRPERPInterface;
