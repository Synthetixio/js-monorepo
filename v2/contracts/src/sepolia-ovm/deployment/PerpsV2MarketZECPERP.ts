...
export interface PerpsV2MarketZECPERPInterface extends utils.Interface {
  functions: {
...
export interface PerpsV2MarketZECPERP extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PerpsV2MarketZECPERPInterface;
