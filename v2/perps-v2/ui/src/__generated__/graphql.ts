...
export type PositionsMarketQuery = { __typename?: 'Query', futuresPositions: Array<{ __typename?: 'FuturesPosition', entryPrice: string, avgEntryPrice: string, leverage: string, feesPaidToSynthetix: string, id: string, pnl: string, lastPrice: string, netFunding: string, market: { __typename?: 'FuturesMarket', marketKey: string, asset: string } }> };
