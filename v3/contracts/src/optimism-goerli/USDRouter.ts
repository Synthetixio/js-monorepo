...
export const address = '0xB0F80A673C5eE48BaB8F0FE65c1CDEc9CCC4B14e';
export const abi = [
...
export const name = 'USDRouter';
export const source = 'contracts/routers/chain-420/USDRouter.sol';
...
export interface USDRouterInterface extends utils.Interface {
  functions: {
...
export interface USDRouter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: USDRouterInterface;
