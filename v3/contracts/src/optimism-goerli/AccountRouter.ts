...
export const address = '0x56C94306BF3e8cE0AfA2C56EB07c453Cd6Bec675';
export const abi = [
...
export const name = 'AccountRouter';
export const source = 'contracts/routers/chain-420/AccountRouter.sol';
...
export interface AccountRouterInterface extends utils.Interface {
  functions: {
...
export interface AccountRouter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AccountRouterInterface;
