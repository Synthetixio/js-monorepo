...
export interface InitialCoreProxyInterface extends utils.Interface {
  functions: {
...
export interface InitialCoreProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: InitialCoreProxyInterface;
