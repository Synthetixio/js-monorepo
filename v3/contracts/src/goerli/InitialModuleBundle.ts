...
export const address = '0x0831dd3d62fF9418C8bd749A4D67c9F47d5FdFe5';
export const abi = [
...
export const name = 'InitialModuleBundle';
export const source = 'contracts/modules/InitialModuleBundle.sol';
...
export interface InitialModuleBundleInterface extends utils.Interface {
  functions: {
...
export interface InitialModuleBundle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: InitialModuleBundleInterface;
