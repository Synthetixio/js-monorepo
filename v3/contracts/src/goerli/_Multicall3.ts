...
export interface _Multicall3Interface extends utils.Interface {
  functions: {
...
export interface _Multicall3 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: _Multicall3Interface;
