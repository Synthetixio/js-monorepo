...
export const name = 'ChainlinkAggregator';
...
export interface _ChainlinkAggregatorInterface extends utils.Interface {
  functions: {
...
export interface _ChainlinkAggregator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: _ChainlinkAggregatorInterface;
